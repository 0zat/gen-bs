...
(* modules *)
 module Console = struct
    ...
    external assert_ : condition:Js.boolean -> ?message:string Js.undefined -> console:('own) console_like -> unit = "assert" [@@bs.send.pipe: ('own) console_like] 
    ...
    external time : message:string -> console:('own) console_like -> unit = "time" [@@bs.send.pipe: ('own) console_like] 
    external timeEnd : message:string -> console:('own) console_like -> unit = "timeEnd" [@@bs.send.pipe: ('own) console_like] 
 ...
 module Performance = struct
    ...
    external now : performance:('own) performance_like -> float = "now" [@@bs.send.pipe: ('own) performance_like] 
 ...
 module CustomElementRegistry = struct
    ...
    external define : name:string -> constructor_:('a1 -> 'a2 [@bs]) -> ?options:(_) elementDefinitionOptions_like Js.undefined -> customElementRegistry:('own) customElementRegistry_like -> unit = "define" [@@bs.send.pipe: ('own) customElementRegistry_like] 
    external get : name:string -> customElementRegistry:('own) customElementRegistry_like -> 'a3 = "get" [@@bs.send.pipe: ('own) customElementRegistry_like] 
    external whenDefined : name:string -> customElementRegistry:('own) customElementRegistry_like -> unit Js.Promise.t = "whenDefined" [@@bs.send.pipe: ('own) customElementRegistry_like] 
 ...
 module GamepadList = struct
    ...
    external item : index:int -> gamepadList:('own) gamepadList_like -> gamepad option = "item" [@@bs.send.pipe: ('own) gamepadList_like] [@@bs.return null_to_opt]
 ...
 module URLSearchParams = struct
    ...
    external append : name:string -> value:string -> uRLSearchParams:('own) uRLSearchParams_like -> unit = "append" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
    external delete : name:string -> uRLSearchParams:('own) uRLSearchParams_like -> unit = "delete" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
    external get : name:string -> uRLSearchParams:('own) uRLSearchParams_like -> string option = "get" [@@bs.send.pipe: ('own) uRLSearchParams_like] [@@bs.return null_to_opt]
    external getAll : name:string -> uRLSearchParams:('own) uRLSearchParams_like -> string array = "getAll" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
    external has : name:string -> uRLSearchParams:('own) uRLSearchParams_like -> bool = "has" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
    external set : name:string -> value:string -> uRLSearchParams:('own) uRLSearchParams_like -> unit = "set" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
    external toString : uRLSearchParams:('own) uRLSearchParams_like -> string = "toString" [@@bs.send.pipe: ('own) uRLSearchParams_like] 
 ...
 module MimeTypeArray = struct
    ...
    external item : index:int -> mimeTypeArray:('own) mimeTypeArray_like -> mimeType option = "item" [@@bs.send.pipe: ('own) mimeTypeArray_like] [@@bs.return null_to_opt]
    external namedItem : name:string -> mimeTypeArray:('own) mimeTypeArray_like -> mimeType option = "namedItem" [@@bs.send.pipe: ('own) mimeTypeArray_like] [@@bs.return null_to_opt]
 ...
 module FormData = struct
    ...
    external append : name:string -> value:(_) blob_like -> ?filename:string Js.undefined -> formData:('own) formData_like -> unit = "append" [@@bs.send.pipe: ('own) formData_like] 
    external delete : name:string -> formData:('own) formData_like -> unit = "delete" [@@bs.send.pipe: ('own) formData_like] 
    external get : name:string -> formData:('own) formData_like -> 'a4 option = "get" [@@bs.send.pipe: ('own) formData_like] [@@bs.return null_to_opt]
    external getAll : name:string -> formData:('own) formData_like -> 'a5 array = "getAll" [@@bs.send.pipe: ('own) formData_like] 
    external has : name:string -> formData:('own) formData_like -> bool = "has" [@@bs.send.pipe: ('own) formData_like] 
    external set : name:string -> value:(_) blob_like -> ?filename:string Js.undefined -> formData:('own) formData_like -> unit = "set" [@@bs.send.pipe: ('own) formData_like] 
 ...
 module TreeWalker = struct
    ...
    external firstChild : treeWalker:('own) treeWalker_like -> node option = "firstChild" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external lastChild : treeWalker:('own) treeWalker_like -> node option = "lastChild" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external nextNode : treeWalker:('own) treeWalker_like -> node option = "nextNode" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external nextSibling : treeWalker:('own) treeWalker_like -> node option = "nextSibling" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external parentNode : treeWalker:('own) treeWalker_like -> node option = "parentNode" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external previousNode : treeWalker:('own) treeWalker_like -> node option = "previousNode" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
    external previousSibling : treeWalker:('own) treeWalker_like -> node option = "previousSibling" [@@bs.send.pipe: ('own) treeWalker_like] [@@bs.return null_to_opt]
 ...
 module DOMMatrixReadOnly = struct
    ...
    external flipX : dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "flipX" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external flipY : dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "flipY" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external fromMatrix : ?other:(_) dOMMatrixInit_like Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrixReadOnly = "fromMatrix" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external inverse : dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "inverse" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external multiply : ?other:(_) dOMMatrixInit_like Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "multiply" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external rotate : ?rotX:float Js.undefined -> ?rotY:float Js.undefined -> ?rotZ:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "rotate" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external rotateAxisAngle : ?x:float Js.undefined -> ?y:float Js.undefined -> ?z:float Js.undefined -> ?angle:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "rotateAxisAngle" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external rotateFromVector : ?x:float Js.undefined -> ?y:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "rotateFromVector" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external scale : ?scaleX:float Js.undefined -> ?scaleY:float Js.undefined -> ?scaleZ:float Js.undefined -> ?originX:float Js.undefined -> ?originY:float Js.undefined -> ?originZ:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "scale" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external scale3d : ?scale:float Js.undefined -> ?originX:float Js.undefined -> ?originY:float Js.undefined -> ?originZ:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "scale3d" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external skewX : ?sx:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "skewX" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external skewY : ?sy:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "skewY" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external transformPoint : ?point:(_) dOMPointInit_like Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMPoint = "transformPoint" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
    external translate : ?tx:float Js.undefined -> ?ty:float Js.undefined -> ?tz:float Js.undefined -> dOMMatrixReadOnly:('own) dOMMatrixReadOnly_like -> dOMMatrix = "translate" [@@bs.send.pipe: ('own) dOMMatrixReadOnly_like] 
 ...
 module ParentNode = struct
    ...
    external querySelector : selectors:string -> parentNode:('own) parentNode_like -> element option = "querySelector" [@@bs.send.pipe: ('own) parentNode_like] [@@bs.return null_to_opt]
    external querySelectorAll : selectors:string -> parentNode:('own) parentNode_like -> nodeList = "querySelectorAll" [@@bs.send.pipe: ('own) parentNode_like] 
 ...
 module Range = struct
    ...
    external cloneContents : range:('own) range_like -> documentFragment = "cloneContents" [@@bs.send.pipe: ('own) range_like] 
    external cloneRange : range:('own) range_like -> range = "cloneRange" [@@bs.send.pipe: ('own) range_like] 
    external collapse : ?toStart:Js.boolean Js.undefined -> range:('own) range_like -> unit = "collapse" [@@bs.send.pipe: ('own) range_like] 
    external compareBoundaryPoints : how:int -> sourceRange:(_) range_like -> range:('own) range_like -> int = "compareBoundaryPoints" [@@bs.send.pipe: ('own) range_like] 
    external comparePoint : node:(_) node_like -> offset:int -> range:('own) range_like -> int = "comparePoint" [@@bs.send.pipe: ('own) range_like] 
    external createContextualFragment : fragment:string -> range:('own) range_like -> documentFragment = "createContextualFragment" [@@bs.send.pipe: ('own) range_like] 
    external deleteContents : range:('own) range_like -> unit = "deleteContents" [@@bs.send.pipe: ('own) range_like] 
    external detach : range:('own) range_like -> unit = "detach" [@@bs.send.pipe: ('own) range_like] 
    external extractContents : range:('own) range_like -> documentFragment = "extractContents" [@@bs.send.pipe: ('own) range_like] 
    external insertNode : node:(_) node_like -> range:('own) range_like -> unit = "insertNode" [@@bs.send.pipe: ('own) range_like] 
    external intersectsNode : node:(_) node_like -> range:('own) range_like -> bool = "intersectsNode" [@@bs.send.pipe: ('own) range_like] 
    external isPointInRange : node:(_) node_like -> offset:int -> range:('own) range_like -> bool = "isPointInRange" [@@bs.send.pipe: ('own) range_like] 
    external selectNode : refNode:(_) node_like -> range:('own) range_like -> unit = "selectNode" [@@bs.send.pipe: ('own) range_like] 
    external selectNodeContents : refNode:(_) node_like -> range:('own) range_like -> unit = "selectNodeContents" [@@bs.send.pipe: ('own) range_like] 
    external setEnd : refNode:(_) node_like -> offset:int -> range:('own) range_like -> unit = "setEnd" [@@bs.send.pipe: ('own) range_like] 
    external setEndAfter : refNode:(_) node_like -> range:('own) range_like -> unit = "setEndAfter" [@@bs.send.pipe: ('own) range_like] 
    external setEndBefore : refNode:(_) node_like -> range:('own) range_like -> unit = "setEndBefore" [@@bs.send.pipe: ('own) range_like] 
    external setStart : refNode:(_) node_like -> offset:int -> range:('own) range_like -> unit = "setStart" [@@bs.send.pipe: ('own) range_like] 
    external setStartAfter : refNode:(_) node_like -> range:('own) range_like -> unit = "setStartAfter" [@@bs.send.pipe: ('own) range_like] 
    external setStartBefore : refNode:(_) node_like -> range:('own) range_like -> unit = "setStartBefore" [@@bs.send.pipe: ('own) range_like] 
    external surroundContents : newParent:(_) node_like -> range:('own) range_like -> unit = "surroundContents" [@@bs.send.pipe: ('own) range_like] 
    external toString : range:('own) range_like -> string = "toString" [@@bs.send.pipe: ('own) range_like] 
 ...
 module WindowOrWorkerGlobalScope = struct
    ...
    external fetch : input:'a8 -> ?init:(_) requestInit_like Js.undefined -> windowOrWorkerGlobalScope:('own) windowOrWorkerGlobalScope_like -> response Js.Promise.t = "fetch" [@@bs.send.pipe: ('own) windowOrWorkerGlobalScope_like] 
 ...
 module OESVertexArrayObject = struct
    ...
    external bindVertexArrayOES : arrayObject:(_) webGLVertexArrayObjectOES_like Js.null -> oESVertexArrayObject:('own) oESVertexArrayObject_like -> unit = "bindVertexArrayOES" [@@bs.send.pipe: ('own) oESVertexArrayObject_like] 
    external createVertexArrayOES : oESVertexArrayObject:('own) oESVertexArrayObject_like -> webGLVertexArrayObjectOES option = "createVertexArrayOES" [@@bs.send.pipe: ('own) oESVertexArrayObject_like] [@@bs.return null_to_opt]
    external deleteVertexArrayOES : arrayObject:(_) webGLVertexArrayObjectOES_like Js.null -> oESVertexArrayObject:('own) oESVertexArrayObject_like -> unit = "deleteVertexArrayOES" [@@bs.send.pipe: ('own) oESVertexArrayObject_like] 
    external isVertexArrayOES : arrayObject:(_) webGLVertexArrayObjectOES_like Js.null -> oESVertexArrayObject:('own) oESVertexArrayObject_like -> bool = "isVertexArrayOES" [@@bs.send.pipe: ('own) oESVertexArrayObject_like] 
 ...
 module TestRunner = struct
    ...
    external setBluetoothMockDataSet : dataSetName:string -> testRunner:('own) testRunner_like -> unit = "setBluetoothMockDataSet" [@@bs.send.pipe: ('own) testRunner_like] 
 ...
 module EventTarget = struct
    ...
    external addEventListener : type_:string -> listener:(_) eventListener_like Js.null -> ?capture:Js.boolean Js.undefined -> eventTarget:('own) eventTarget_like -> unit = "addEventListener" [@@bs.send.pipe: ('own) eventTarget_like] 
    external dispatchEvent : event:(_) event_like -> eventTarget:('own) eventTarget_like -> bool = "dispatchEvent" [@@bs.send.pipe: ('own) eventTarget_like] 
    external removeEventListener : type_:string -> listener:(_) eventListener_like Js.null -> ?capture:Js.boolean Js.undefined -> eventTarget:('own) eventTarget_like -> unit = "removeEventListener" [@@bs.send.pipe: ('own) eventTarget_like] 
 ...
 module NodeIterator = struct
    ...
    external detach : nodeIterator:('own) nodeIterator_like -> unit = "detach" [@@bs.send.pipe: ('own) nodeIterator_like] 
    external nextNode : nodeIterator:('own) nodeIterator_like -> node option = "nextNode" [@@bs.send.pipe: ('own) nodeIterator_like] [@@bs.return null_to_opt]
    external previousNode : nodeIterator:('own) nodeIterator_like -> node option = "previousNode" [@@bs.send.pipe: ('own) nodeIterator_like] [@@bs.return null_to_opt]
 ...
 module BluetoothRemoteGATTServer = struct
    ...
    external connect : bluetoothRemoteGATTServer:('own) bluetoothRemoteGATTServer_like -> bluetoothRemoteGATTServer Js.Promise.t = "connect" [@@bs.send.pipe: ('own) bluetoothRemoteGATTServer_like] 
    external disconnect : bluetoothRemoteGATTServer:('own) bluetoothRemoteGATTServer_like -> unit = "disconnect" [@@bs.send.pipe: ('own) bluetoothRemoteGATTServer_like] 
    external getPrimaryService : service:'a9 -> bluetoothRemoteGATTServer:('own) bluetoothRemoteGATTServer_like -> bluetoothRemoteGATTService Js.Promise.t = "getPrimaryService" [@@bs.send.pipe: ('own) bluetoothRemoteGATTServer_like] 
    external getPrimaryServices : ?service:'a10 Js.undefined -> bluetoothRemoteGATTServer:('own) bluetoothRemoteGATTServer_like -> bluetoothRemoteGATTService array Js.Promise.t = "getPrimaryServices" [@@bs.send.pipe: ('own) bluetoothRemoteGATTServer_like] 
 ...
 module WebGLRenderingContextBase = struct
    ...
    external activeTexture : texture:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "activeTexture" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external attachShader : program:(_) webGLProgram_like Js.null -> shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "attachShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bindAttribLocation : program:(_) webGLProgram_like Js.null -> index:int -> name:string -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bindAttribLocation" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bindBuffer : target:int -> buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bindBuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bindFramebuffer : target:int -> framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bindFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bindRenderbuffer : target:int -> renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bindRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bindTexture : target:int -> texture:(_) webGLTexture_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bindTexture" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external blendColor : red:float -> green:float -> blue:float -> alpha:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "blendColor" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external blendEquation : mode:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "blendEquation" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external blendEquationSeparate : modeRGB:int -> modeAlpha:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "blendEquationSeparate" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external blendFunc : sfactor:int -> dfactor:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "blendFunc" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external blendFuncSeparate : srcRGB:int -> dstRGB:int -> srcAlpha:int -> dstAlpha:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "blendFuncSeparate" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bufferData : target:int -> data:'a11 -> usage:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bufferData" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external bufferSubData : target:int -> offset:int -> data:'a12 Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "bufferSubData" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external checkFramebufferStatus : target:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> int = "checkFramebufferStatus" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external clear : mask:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "clear" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external clearColor : red:float -> green:float -> blue:float -> alpha:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "clearColor" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external clearDepth : depth:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "clearDepth" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external clearStencil : s:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "clearStencil" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external colorMask : red:Js.boolean -> green:Js.boolean -> blue:Js.boolean -> alpha:Js.boolean -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "colorMask" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external compileShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "compileShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external compressedTexImage2D : target:int -> level:int -> internalformat:int -> width:int -> height:int -> border:int -> data:'a13 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "compressedTexImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external compressedTexSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> width:int -> height:int -> format:int -> data:'a14 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "compressedTexSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external copyTexImage2D : target:int -> level:int -> internalformat:int -> x:int -> y:int -> width:int -> height:int -> border:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "copyTexImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external copyTexSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> x:int -> y:int -> width:int -> height:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "copyTexSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external createBuffer : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLBuffer option = "createBuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external createFramebuffer : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLFramebuffer option = "createFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external createProgram : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLProgram option = "createProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external createRenderbuffer : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLRenderbuffer option = "createRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external createShader : type_:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLShader option = "createShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external createTexture : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLTexture option = "createTexture" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external cullFace : mode:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "cullFace" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteBuffer : buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteBuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteFramebuffer : framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteRenderbuffer : renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external deleteTexture : texture:(_) webGLTexture_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "deleteTexture" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external depthFunc : func:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "depthFunc" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external depthMask : flag:Js.boolean -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "depthMask" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external depthRange : zNear:float -> zFar:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "depthRange" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external detachShader : program:(_) webGLProgram_like Js.null -> shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "detachShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external disable : cap:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "disable" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external disableVertexAttribArray : index:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "disableVertexAttribArray" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external drawArrays : mode:int -> first:int -> count:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "drawArrays" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external drawElements : mode:int -> count:int -> type_:int -> offset:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "drawElements" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external enable : cap:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "enable" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external enableVertexAttribArray : index:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "enableVertexAttribArray" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external finish : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "finish" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external flush : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "flush" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external framebufferRenderbuffer : target:int -> attachment:int -> renderbuffertarget:int -> renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "framebufferRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external framebufferTexture2D : target:int -> attachment:int -> textarget:int -> texture:(_) webGLTexture_like Js.null -> level:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "framebufferTexture2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external frontFace : mode:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "frontFace" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external generateMipmap : target:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "generateMipmap" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getActiveAttrib : program:(_) webGLProgram_like Js.null -> index:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLActiveInfo option = "getActiveAttrib" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getActiveUniform : program:(_) webGLProgram_like Js.null -> index:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLActiveInfo option = "getActiveUniform" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getAttribLocation : program:(_) webGLProgram_like Js.null -> name:string -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> int = "getAttribLocation" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getBufferParameter : target:int -> pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a15 = "getBufferParameter" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getContextAttributes : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLContextAttributes option = "getContextAttributes" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getError : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> int = "getError" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getExtension : name:string -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a16 option = "getExtension" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getParameter : pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a17 = "getParameter" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getProgramInfoLog : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> string option = "getProgramInfoLog" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getProgramParameter : program:(_) webGLProgram_like Js.null -> pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a18 = "getProgramParameter" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getShaderInfoLog : shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> string option = "getShaderInfoLog" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getShaderParameter : shader:(_) webGLShader_like Js.null -> pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a19 = "getShaderParameter" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getShaderPrecisionFormat : shadertype:int -> precisiontype:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLShaderPrecisionFormat option = "getShaderPrecisionFormat" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getShaderSource : shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> string option = "getShaderSource" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getSupportedExtensions : webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> string array option = "getSupportedExtensions" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getUniformLocation : program:(_) webGLProgram_like Js.null -> name:string -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> webGLUniformLocation option = "getUniformLocation" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] [@@bs.return null_to_opt]
    external getVertexAttrib : index:int -> pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> 'a20 = "getVertexAttrib" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external getVertexAttribOffset : index:int -> pname:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> int = "getVertexAttribOffset" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external hint : target:int -> mode:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "hint" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isBuffer : buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isBuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isEnabled : cap:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isEnabled" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isFramebuffer : framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isRenderbuffer : renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isShader" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external isTexture : texture:(_) webGLTexture_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> bool = "isTexture" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external lineWidth : width:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "lineWidth" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external linkProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "linkProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external pixelStorei : pname:int -> param:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "pixelStorei" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external polygonOffset : factor:float -> units:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "polygonOffset" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external readPixels : x:int -> y:int -> width:int -> height:int -> format:int -> type_:int -> pixels:'a21 Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "readPixels" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external renderbufferStorage : target:int -> internalformat:int -> width:int -> height:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "renderbufferStorage" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external sampleCoverage : value:float -> invert:Js.boolean -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "sampleCoverage" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external scissor : x:int -> y:int -> width:int -> height:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "scissor" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external shaderSource : shader:(_) webGLShader_like Js.null -> source:string -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "shaderSource" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilFunc : func:int -> ref:int -> mask:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilFunc" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilFuncSeparate : face:int -> func:int -> ref:int -> mask:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilFuncSeparate" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilMask : mask:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilMask" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilMaskSeparate : face:int -> mask:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilMaskSeparate" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilOp : fail:int -> zfail:int -> zpass:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilOp" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external stencilOpSeparate : face:int -> fail:int -> zfail:int -> zpass:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "stencilOpSeparate" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external texImage2D : target:int -> level:int -> internalformat:int -> format:int -> type_:int -> source:'a22 Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "texImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external texParameterf : target:int -> pname:int -> param:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "texParameterf" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external texParameteri : target:int -> pname:int -> param:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "texParameteri" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external texSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> format:int -> type_:int -> source:'a23 Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "texSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform1f : location:(_) webGLUniformLocation_like Js.null -> x:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform1f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform1fv : location:(_) webGLUniformLocation_like Js.null -> v:'a24 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform1fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform1i : location:(_) webGLUniformLocation_like Js.null -> x:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform1i" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform1iv : location:(_) webGLUniformLocation_like Js.null -> v:'a25 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform1iv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform2f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform2f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform2fv : location:(_) webGLUniformLocation_like Js.null -> v:'a26 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform2fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform2i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform2i" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform2iv : location:(_) webGLUniformLocation_like Js.null -> v:'a27 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform2iv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform3f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> z:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform3f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform3fv : location:(_) webGLUniformLocation_like Js.null -> v:'a28 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform3fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform3i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> z:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform3i" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform3iv : location:(_) webGLUniformLocation_like Js.null -> v:'a29 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform3iv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform4f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> z:float -> w:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform4f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform4fv : location:(_) webGLUniformLocation_like Js.null -> v:'a30 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform4fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform4i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> z:int -> w:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform4i" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniform4iv : location:(_) webGLUniformLocation_like Js.null -> v:'a31 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniform4iv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniformMatrix2fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a32 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniformMatrix2fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniformMatrix3fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a33 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniformMatrix3fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external uniformMatrix4fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a34 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "uniformMatrix4fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external useProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "useProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external validateProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "validateProgram" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib1f : indx:int -> x:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib1f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib1fv : indx:int -> values:'a35 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib1fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib2f : indx:int -> x:float -> y:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib2f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib2fv : indx:int -> values:'a36 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib2fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib3f : indx:int -> x:float -> y:float -> z:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib3f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib3fv : indx:int -> values:'a37 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib3fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib4f : indx:int -> x:float -> y:float -> z:float -> w:float -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib4f" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttrib4fv : indx:int -> values:'a38 -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttrib4fv" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external vertexAttribPointer : indx:int -> size:int -> type_:int -> normalized:Js.boolean -> stride:int -> offset:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "vertexAttribPointer" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
    external viewport : x:int -> y:int -> width:int -> height:int -> webGLRenderingContextBase:('own) webGLRenderingContextBase_like -> unit = "viewport" [@@bs.send.pipe: ('own) webGLRenderingContextBase_like] 
 ...
 module WebGLRenderingContext = struct
    ...
    external activeTexture : texture:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "activeTexture" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external attachShader : program:(_) webGLProgram_like Js.null -> shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "attachShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bindAttribLocation : program:(_) webGLProgram_like Js.null -> index:int -> name:string -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bindAttribLocation" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bindBuffer : target:int -> buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bindBuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bindFramebuffer : target:int -> framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bindFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bindRenderbuffer : target:int -> renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bindRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bindTexture : target:int -> texture:(_) webGLTexture_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bindTexture" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external blendColor : red:float -> green:float -> blue:float -> alpha:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "blendColor" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external blendEquation : mode:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "blendEquation" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external blendEquationSeparate : modeRGB:int -> modeAlpha:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "blendEquationSeparate" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external blendFunc : sfactor:int -> dfactor:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "blendFunc" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external blendFuncSeparate : srcRGB:int -> dstRGB:int -> srcAlpha:int -> dstAlpha:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "blendFuncSeparate" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bufferData : target:int -> data:'a40 -> usage:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bufferData" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external bufferSubData : target:int -> offset:int -> data:'a41 Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "bufferSubData" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external checkFramebufferStatus : target:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> int = "checkFramebufferStatus" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external clear : mask:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "clear" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external clearColor : red:float -> green:float -> blue:float -> alpha:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "clearColor" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external clearDepth : depth:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "clearDepth" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external clearStencil : s:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "clearStencil" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external colorMask : red:Js.boolean -> green:Js.boolean -> blue:Js.boolean -> alpha:Js.boolean -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "colorMask" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external compileShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "compileShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external compressedTexImage2D : target:int -> level:int -> internalformat:int -> width:int -> height:int -> border:int -> data:'a42 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "compressedTexImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external compressedTexSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> width:int -> height:int -> format:int -> data:'a43 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "compressedTexSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external copyTexImage2D : target:int -> level:int -> internalformat:int -> x:int -> y:int -> width:int -> height:int -> border:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "copyTexImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external copyTexSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> x:int -> y:int -> width:int -> height:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "copyTexSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external createBuffer : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLBuffer option = "createBuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external createFramebuffer : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLFramebuffer option = "createFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external createProgram : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLProgram option = "createProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external createRenderbuffer : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLRenderbuffer option = "createRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external createShader : type_:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> webGLShader option = "createShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external createTexture : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLTexture option = "createTexture" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external cullFace : mode:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "cullFace" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteBuffer : buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteBuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteFramebuffer : framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteRenderbuffer : renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external deleteTexture : texture:(_) webGLTexture_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "deleteTexture" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external depthFunc : func:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "depthFunc" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external depthMask : flag:Js.boolean -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "depthMask" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external depthRange : zNear:float -> zFar:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "depthRange" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external detachShader : program:(_) webGLProgram_like Js.null -> shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "detachShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external disable : cap:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "disable" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external disableVertexAttribArray : index:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "disableVertexAttribArray" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external drawArrays : mode:int -> first:int -> count:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "drawArrays" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external drawElements : mode:int -> count:int -> type_:int -> offset:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "drawElements" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external enable : cap:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "enable" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external enableVertexAttribArray : index:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "enableVertexAttribArray" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external finish : webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "finish" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external flush : webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "flush" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external framebufferRenderbuffer : target:int -> attachment:int -> renderbuffertarget:int -> renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "framebufferRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external framebufferTexture2D : target:int -> attachment:int -> textarget:int -> texture:(_) webGLTexture_like Js.null -> level:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "framebufferTexture2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external frontFace : mode:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "frontFace" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external generateMipmap : target:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "generateMipmap" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getActiveAttrib : program:(_) webGLProgram_like Js.null -> index:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> webGLActiveInfo option = "getActiveAttrib" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getActiveUniform : program:(_) webGLProgram_like Js.null -> index:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> webGLActiveInfo option = "getActiveUniform" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getAttribLocation : program:(_) webGLProgram_like Js.null -> name:string -> webGLRenderingContext:('own) webGLRenderingContext_like -> int = "getAttribLocation" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getBufferParameter : target:int -> pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a44 = "getBufferParameter" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getContextAttributes : webGLRenderingContext:('own) webGLRenderingContext_like -> webGLContextAttributes option = "getContextAttributes" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getError : webGLRenderingContext:('own) webGLRenderingContext_like -> int = "getError" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getExtension : name:string -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a45 option = "getExtension" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getParameter : pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a46 = "getParameter" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getProgramInfoLog : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> string option = "getProgramInfoLog" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getProgramParameter : program:(_) webGLProgram_like Js.null -> pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a47 = "getProgramParameter" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getShaderInfoLog : shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> string option = "getShaderInfoLog" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getShaderParameter : shader:(_) webGLShader_like Js.null -> pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a48 = "getShaderParameter" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getShaderPrecisionFormat : shadertype:int -> precisiontype:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> webGLShaderPrecisionFormat option = "getShaderPrecisionFormat" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getShaderSource : shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> string option = "getShaderSource" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getSupportedExtensions : webGLRenderingContext:('own) webGLRenderingContext_like -> string array option = "getSupportedExtensions" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getUniformLocation : program:(_) webGLProgram_like Js.null -> name:string -> webGLRenderingContext:('own) webGLRenderingContext_like -> webGLUniformLocation option = "getUniformLocation" [@@bs.send.pipe: ('own) webGLRenderingContext_like] [@@bs.return null_to_opt]
    external getVertexAttrib : index:int -> pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> 'a49 = "getVertexAttrib" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external getVertexAttribOffset : index:int -> pname:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> int = "getVertexAttribOffset" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external hint : target:int -> mode:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "hint" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isBuffer : buffer:(_) webGLBuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isBuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isEnabled : cap:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isEnabled" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isFramebuffer : framebuffer:(_) webGLFramebuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isFramebuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isRenderbuffer : renderbuffer:(_) webGLRenderbuffer_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isRenderbuffer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isShader : shader:(_) webGLShader_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isShader" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external isTexture : texture:(_) webGLTexture_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> bool = "isTexture" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external lineWidth : width:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "lineWidth" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external linkProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "linkProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external pixelStorei : pname:int -> param:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "pixelStorei" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external polygonOffset : factor:float -> units:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "polygonOffset" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external readPixels : x:int -> y:int -> width:int -> height:int -> format:int -> type_:int -> pixels:'a50 Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "readPixels" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external renderbufferStorage : target:int -> internalformat:int -> width:int -> height:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "renderbufferStorage" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external sampleCoverage : value:float -> invert:Js.boolean -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "sampleCoverage" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external scissor : x:int -> y:int -> width:int -> height:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "scissor" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external shaderSource : shader:(_) webGLShader_like Js.null -> source:string -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "shaderSource" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilFunc : func:int -> ref:int -> mask:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilFunc" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilFuncSeparate : face:int -> func:int -> ref:int -> mask:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilFuncSeparate" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilMask : mask:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilMask" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilMaskSeparate : face:int -> mask:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilMaskSeparate" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilOp : fail:int -> zfail:int -> zpass:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilOp" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external stencilOpSeparate : face:int -> fail:int -> zfail:int -> zpass:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "stencilOpSeparate" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external texImage2D : target:int -> level:int -> internalformat:int -> format:int -> type_:int -> source:'a51 Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "texImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external texParameterf : target:int -> pname:int -> param:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "texParameterf" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external texParameteri : target:int -> pname:int -> param:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "texParameteri" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external texSubImage2D : target:int -> level:int -> xoffset:int -> yoffset:int -> format:int -> type_:int -> source:'a52 Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "texSubImage2D" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform1f : location:(_) webGLUniformLocation_like Js.null -> x:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform1f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform1fv : location:(_) webGLUniformLocation_like Js.null -> v:'a53 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform1fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform1i : location:(_) webGLUniformLocation_like Js.null -> x:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform1i" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform1iv : location:(_) webGLUniformLocation_like Js.null -> v:'a54 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform1iv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform2f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform2f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform2fv : location:(_) webGLUniformLocation_like Js.null -> v:'a55 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform2fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform2i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform2i" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform2iv : location:(_) webGLUniformLocation_like Js.null -> v:'a56 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform2iv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform3f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> z:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform3f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform3fv : location:(_) webGLUniformLocation_like Js.null -> v:'a57 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform3fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform3i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> z:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform3i" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform3iv : location:(_) webGLUniformLocation_like Js.null -> v:'a58 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform3iv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform4f : location:(_) webGLUniformLocation_like Js.null -> x:float -> y:float -> z:float -> w:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform4f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform4fv : location:(_) webGLUniformLocation_like Js.null -> v:'a59 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform4fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform4i : location:(_) webGLUniformLocation_like Js.null -> x:int -> y:int -> z:int -> w:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform4i" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniform4iv : location:(_) webGLUniformLocation_like Js.null -> v:'a60 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniform4iv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniformMatrix2fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a61 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniformMatrix2fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniformMatrix3fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a62 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniformMatrix3fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external uniformMatrix4fv : location:(_) webGLUniformLocation_like Js.null -> transpose:Js.boolean -> v:'a63 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "uniformMatrix4fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external useProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "useProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external validateProgram : program:(_) webGLProgram_like Js.null -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "validateProgram" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib1f : indx:int -> x:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib1f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib1fv : indx:int -> values:'a64 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib1fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib2f : indx:int -> x:float -> y:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib2f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib2fv : indx:int -> values:'a65 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib2fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib3f : indx:int -> x:float -> y:float -> z:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib3f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib3fv : indx:int -> values:'a66 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib3fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib4f : indx:int -> x:float -> y:float -> z:float -> w:float -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib4f" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttrib4fv : indx:int -> values:'a67 -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttrib4fv" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external vertexAttribPointer : indx:int -> size:int -> type_:int -> normalized:Js.boolean -> stride:int -> offset:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "vertexAttribPointer" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
    external viewport : x:int -> y:int -> width:int -> height:int -> webGLRenderingContext:('own) webGLRenderingContext_like -> unit = "viewport" [@@bs.send.pipe: ('own) webGLRenderingContext_like] 
 ...
 module Location = struct
    ...
    external assign : url:string -> location:('own) location_like -> unit = "assign" [@@bs.send.pipe: ('own) location_like] 
    external reload : location:('own) location_like -> unit = "reload" [@@bs.send.pipe: ('own) location_like] 
    external replace : url:string -> location:('own) location_like -> unit = "replace" [@@bs.send.pipe: ('own) location_like] 
    external toString : location:('own) location_like -> string = "toString" [@@bs.send.pipe: ('own) location_like] 
 ...
 module Body = struct
    ...
    external blob : body:('own) body_like -> blob Js.Promise.t = "blob" [@@bs.send.pipe: ('own) body_like] 
    external formData : body:('own) body_like -> formData Js.Promise.t = "formData" [@@bs.send.pipe: ('own) body_like] 
    external json : body:('own) body_like -> 'a69 Js.Promise.t = "json" [@@bs.send.pipe: ('own) body_like] 
    external text : body:('own) body_like -> string Js.Promise.t = "text" [@@bs.send.pipe: ('own) body_like] 
 ...
 module History = struct
    ...
    external back : history:('own) history_like -> unit = "back" [@@bs.send.pipe: ('own) history_like] 
    external forward : history:('own) history_like -> unit = "forward" [@@bs.send.pipe: ('own) history_like] 
    external go : ?delta:int Js.undefined -> history:('own) history_like -> unit = "go" [@@bs.send.pipe: ('own) history_like] 
 ...
 module NodeList = struct
    ...
    external item : index:int -> nodeList:('own) nodeList_like -> node option = "item" [@@bs.send.pipe: ('own) nodeList_like] [@@bs.return null_to_opt]
 ...
 module PluginArray = struct
    ...
    external item : index:int -> pluginArray:('own) pluginArray_like -> plugin option = "item" [@@bs.send.pipe: ('own) pluginArray_like] [@@bs.return null_to_opt]
    external namedItem : name:string -> pluginArray:('own) pluginArray_like -> plugin option = "namedItem" [@@bs.send.pipe: ('own) pluginArray_like] [@@bs.return null_to_opt]
    external refresh : ?reload:Js.boolean Js.undefined -> pluginArray:('own) pluginArray_like -> unit = "refresh" [@@bs.send.pipe: ('own) pluginArray_like] 
 ...
 module BluetoothRemoteGATTDescriptor = struct
    ...
    external readValue : bluetoothRemoteGATTDescriptor:('own) bluetoothRemoteGATTDescriptor_like -> string Js.Promise.t = "readValue" [@@bs.send.pipe: ('own) bluetoothRemoteGATTDescriptor_like] 
    external writeValue : value:int array -> bluetoothRemoteGATTDescriptor:('own) bluetoothRemoteGATTDescriptor_like -> unit Js.Promise.t = "writeValue" [@@bs.send.pipe: ('own) bluetoothRemoteGATTDescriptor_like] 
 ...
 module ChildNode = struct
    ...
    external remove : childNode:('own) childNode_like -> unit = "remove" [@@bs.send.pipe: ('own) childNode_like] 
 ...
 module DOMParser = struct
    ...
    external parseFromString : str:string -> type_:string -> dOMParser:('own) dOMParser_like -> document = "parseFromString" [@@bs.send.pipe: ('own) dOMParser_like] 
 ...
 module URL = struct
    ...
    external createObjectURL : blob:(_) blob_like -> uRL:('own) uRL_like -> string = "createObjectURL" [@@bs.send.pipe: ('own) uRL_like] 
    external revokeObjectURL : url:string -> uRL:('own) uRL_like -> unit = "revokeObjectURL" [@@bs.send.pipe: ('own) uRL_like] 
    external toString : uRL:('own) uRL_like -> string = "toString" [@@bs.send.pipe: ('own) uRL_like] 
 ...
 module FileList = struct
    ...
    external item : index:int -> fileList:('own) fileList_like -> file option = "item" [@@bs.send.pipe: ('own) fileList_like] [@@bs.return null_to_opt]
 ...
 module BrowserElement = struct
    ...
    external getVisible : browserElement:('own) browserElement_like -> bool = "getVisible" [@@bs.send.pipe: ('own) browserElement_like] 
    external goBack : browserElement:('own) browserElement_like -> unit = "goBack" [@@bs.send.pipe: ('own) browserElement_like] 
    external goForward : browserElement:('own) browserElement_like -> unit = "goForward" [@@bs.send.pipe: ('own) browserElement_like] 
    external reload : ?hardReload:Js.boolean Js.undefined -> browserElement:('own) browserElement_like -> unit = "reload" [@@bs.send.pipe: ('own) browserElement_like] 
    external setVisible : visible:Js.boolean -> browserElement:('own) browserElement_like -> unit = "setVisible" [@@bs.send.pipe: ('own) browserElement_like] 
    external stop : browserElement:('own) browserElement_like -> unit = "stop" [@@bs.send.pipe: ('own) browserElement_like] 
 ...
 module BrowserElementCommon = struct
    ...
    external getVisible : browserElementCommon:('own) browserElementCommon_like -> bool = "getVisible" [@@bs.send.pipe: ('own) browserElementCommon_like] 
    external setVisible : visible:Js.boolean -> browserElementCommon:('own) browserElementCommon_like -> unit = "setVisible" [@@bs.send.pipe: ('own) browserElementCommon_like] 
 ...
 module BrowserElementPrivileged = struct
    ...
    external goBack : browserElementPrivileged:('own) browserElementPrivileged_like -> unit = "goBack" [@@bs.send.pipe: ('own) browserElementPrivileged_like] 
    external goForward : browserElementPrivileged:('own) browserElementPrivileged_like -> unit = "goForward" [@@bs.send.pipe: ('own) browserElementPrivileged_like] 
    external reload : ?hardReload:Js.boolean Js.undefined -> browserElementPrivileged:('own) browserElementPrivileged_like -> unit = "reload" [@@bs.send.pipe: ('own) browserElementPrivileged_like] 
    external stop : browserElementPrivileged:('own) browserElementPrivileged_like -> unit = "stop" [@@bs.send.pipe: ('own) browserElementPrivileged_like] 
 ...
 module WorkerNavigator = struct
    ...
    external taintEnabled : workerNavigator:('own) workerNavigator_like -> bool = "taintEnabled" [@@bs.send.pipe: ('own) workerNavigator_like] 
 ...
 module HTMLCollection = struct
    ...
    external item : index:int -> hTMLCollection:('own) hTMLCollection_like -> element option = "item" [@@bs.send.pipe: ('own) hTMLCollection_like] [@@bs.return null_to_opt]
    external namedItem : name:string -> hTMLCollection:('own) hTMLCollection_like -> element option = "namedItem" [@@bs.send.pipe: ('own) hTMLCollection_like] [@@bs.return null_to_opt]
 ...
 module NonElementParentNode = struct
    ...
    external getElementById : elementId:string -> nonElementParentNode:('own) nonElementParentNode_like -> element option = "getElementById" [@@bs.send.pipe: ('own) nonElementParentNode_like] [@@bs.return null_to_opt]
 ...
 module CSSRuleList = struct
    ...
    external item : index:int -> cSSRuleList:('own) cSSRuleList_like -> cSSRule option = "item" [@@bs.send.pipe: ('own) cSSRuleList_like] [@@bs.return null_to_opt]
 ...
 module DissimilarOriginLocation = struct
    ...
    external assign : url:string -> dissimilarOriginLocation:('own) dissimilarOriginLocation_like -> unit = "assign" [@@bs.send.pipe: ('own) dissimilarOriginLocation_like] 
    external reload : dissimilarOriginLocation:('own) dissimilarOriginLocation_like -> unit = "reload" [@@bs.send.pipe: ('own) dissimilarOriginLocation_like] 
    external replace : url:string -> dissimilarOriginLocation:('own) dissimilarOriginLocation_like -> unit = "replace" [@@bs.send.pipe: ('own) dissimilarOriginLocation_like] 
    external toString : dissimilarOriginLocation:('own) dissimilarOriginLocation_like -> string = "toString" [@@bs.send.pipe: ('own) dissimilarOriginLocation_like] 
 ...
 module DOMImplementation = struct
    ...
    external createDocument : namespace:string Js.null -> qualifiedName:string -> ?doctype:(_) documentType_like Js.null Js.undefined -> dOMImplementation:('own) dOMImplementation_like -> xMLDocument = "createDocument" [@@bs.send.pipe: ('own) dOMImplementation_like] 
    external createDocumentType : qualifiedName:string -> publicId:string -> systemId:string -> dOMImplementation:('own) dOMImplementation_like -> documentType = "createDocumentType" [@@bs.send.pipe: ('own) dOMImplementation_like] 
    external createHTMLDocument : ?title:string Js.undefined -> dOMImplementation:('own) dOMImplementation_like -> document = "createHTMLDocument" [@@bs.send.pipe: ('own) dOMImplementation_like] 
    external hasFeature : dOMImplementation:('own) dOMImplementation_like -> bool = "hasFeature" [@@bs.send.pipe: ('own) dOMImplementation_like] 
 ...
 module TestBinding = struct
    ...
    external booleanMozPreference : pref_name:string -> testBinding:('own) testBinding_like -> bool = "BooleanMozPreference" [@@bs.send.pipe: ('own) testBinding_like] 
    external stringMozPreference : pref_name:string -> testBinding:('own) testBinding_like -> string = "StringMozPreference" [@@bs.send.pipe: ('own) testBinding_like] 
    external acceptPromise : string:string Js.Promise.t -> testBinding:('own) testBinding_like -> unit = "acceptPromise" [@@bs.send.pipe: ('own) testBinding_like] 
    external advanceClock : millis:int -> ?forceLayoutTick:Js.boolean Js.undefined -> testBinding:('own) testBinding_like -> unit = "advanceClock" [@@bs.send.pipe: ('own) testBinding_like] 
    external crashHard : testBinding:('own) testBinding_like -> unit = "crashHard" [@@bs.send.pipe: ('own) testBinding_like] 
    external dictMatchesPassedValues : arg:(_) testDictionary_like -> testBinding:('own) testBinding_like -> bool = "dictMatchesPassedValues" [@@bs.send.pipe: ('own) testBinding_like] 
    external entryGlobal : testBinding:('own) testBinding_like -> globalScope = "entryGlobal" [@@bs.send.pipe: ('own) testBinding_like] 
    external funcControlledMethodDisabled : testBinding:('own) testBinding_like -> unit = "funcControlledMethodDisabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external funcControlledMethodEnabled : testBinding:('own) testBinding_like -> unit = "funcControlledMethodEnabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external funcControlledStaticMethodDisabled : testBinding:('own) testBinding_like -> unit = "funcControlledStaticMethodDisabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external funcControlledStaticMethodEnabled : testBinding:('own) testBinding_like -> unit = "funcControlledStaticMethodEnabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external incumbentGlobal : testBinding:('own) testBinding_like -> globalScope = "incumbentGlobal" [@@bs.send.pipe: ('own) testBinding_like] 
    external methToBinaryRename : testBinding:('own) testBinding_like -> unit = "methToBinaryRename" [@@bs.send.pipe: ('own) testBinding_like] 
    external panic : testBinding:('own) testBinding_like -> unit = "panic" [@@bs.send.pipe: ('own) testBinding_like] 
    external passAny : arg:'a111 -> testBinding:('own) testBinding_like -> unit = "passAny" [@@bs.send.pipe: ('own) testBinding_like] 
    external passBoolean : arg:Js.boolean -> testBinding:('own) testBinding_like -> unit = "passBoolean" [@@bs.send.pipe: ('own) testBinding_like] 
    external passByte : arg:int -> testBinding:('own) testBinding_like -> unit = "passByte" [@@bs.send.pipe: ('own) testBinding_like] 
    external passByteString : arg:string -> testBinding:('own) testBinding_like -> unit = "passByteString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passByteStringMozMap : arg:'a112 -> testBinding:('own) testBinding_like -> unit = "passByteStringMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passCallbackFunction : fun_:('a113 -> 'a114 [@bs]) -> testBinding:('own) testBinding_like -> unit = "passCallbackFunction" [@@bs.send.pipe: ('own) testBinding_like] 
    external passCallbackInterface : listener:(_) eventListener_like -> testBinding:('own) testBinding_like -> unit = "passCallbackInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passCastableObjectMozMap : arg:'a115 -> testBinding:('own) testBinding_like -> unit = "passCastableObjectMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passCastableObjectNullableMozMap : arg:'a116 Js.null -> testBinding:('own) testBinding_like -> unit = "passCastableObjectNullableMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passDouble : arg:float -> testBinding:('own) testBinding_like -> unit = "passDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passEnum : arg:string -> testBinding:('own) testBinding_like -> unit = "passEnum" [@@bs.send.pipe: ('own) testBinding_like] 
    external passFloat : arg:float -> testBinding:('own) testBinding_like -> unit = "passFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passInterface : arg:(_) blob_like -> testBinding:('own) testBinding_like -> unit = "passInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passInterfaceSequence : seq:(_) blob_like array -> testBinding:('own) testBinding_like -> unit = "passInterfaceSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passLong : arg:int -> testBinding:('own) testBinding_like -> unit = "passLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passLongLong : arg:int -> testBinding:('own) testBinding_like -> unit = "passLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMap : arg:'a117 -> testBinding:('own) testBinding_like -> unit = "passMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMapOfMozMaps : arg:'a118 -> testBinding:('own) testBinding_like -> unit = "passMozMapOfMozMaps" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMapOfNullableInts : arg:'a119 -> testBinding:('own) testBinding_like -> unit = "passMozMapOfNullableInts" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMapUnion : init:'a120 -> testBinding:('own) testBinding_like -> unit = "passMozMapUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMapUnion2 : init:'a121 -> testBinding:('own) testBinding_like -> unit = "passMozMapUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passMozMapUnion3 : init:'a122 -> testBinding:('own) testBinding_like -> unit = "passMozMapUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableBoolean : arg:Js.boolean Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableBoolean" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableByte : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableByte" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableByteString : arg:string Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableByteString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableCallbackFunction : fun_:('a123 -> 'a124 [@bs]) Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableCallbackFunction" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableCallbackInterface : listener:(_) eventListener_like Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableCallbackInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableCastableObjectMozMap : arg:'a125 -> testBinding:('own) testBinding_like -> unit = "passNullableCastableObjectMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableCastableObjectNullableMozMap : arg:'a126 Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableCastableObjectNullableMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableDouble : arg:float Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableFloat : arg:float Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableInterface : arg:(_) blob_like Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableLong : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableLongLong : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableMozMap : arg:'a127 Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableObject : arg:'a128 Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableObject" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableOctet : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableOctet" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableSequence : seq:int array Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableShort : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableString : arg:string Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion : arg:'a129 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion2 : data:'a130 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion3 : data:'a131 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion4 : bool:'a132 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion5 : arg:'a133 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnion6 : arg:'a134 -> testBinding:('own) testBinding_like -> unit = "passNullableUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnrestrictedDouble : arg:float Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnrestrictedFloat : arg:float Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnsignedLong : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnsignedLongLong : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUnsignedShort : arg:int Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passNullableUsvstring : arg:string Js.null -> testBinding:('own) testBinding_like -> unit = "passNullableUsvstring" [@@bs.send.pipe: ('own) testBinding_like] 
    external passObject : arg:'a135 -> testBinding:('own) testBinding_like -> unit = "passObject" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOctet : arg:int -> testBinding:('own) testBinding_like -> unit = "passOctet" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalAny : ?arg:'a136 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalAny" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalAnyWithDefault : ?arg:'a137 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalAnyWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalBoolean : ?arg:Js.boolean Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalBoolean" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalBooleanWithDefault : ?arg:Js.boolean Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalBooleanWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalByte : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalByte" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalByteString : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalByteString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalByteWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalByteWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalBytestringWithDefault : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalBytestringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalCallbackFunction : ?fun_:('a138 -> 'a139 [@bs]) Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalCallbackFunction" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalCallbackInterface : ?listener:(_) eventListener_like Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalCallbackInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalDouble : ?arg:float Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalEnum : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalEnum" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalEnumWithDefault : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalEnumWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalFloat : ?arg:float Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalInterface : ?arg:(_) blob_like Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalLong : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalLongLong : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalLongLongWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalLongLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalLongWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalMozMap : ?arg:'a140 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalMozMapOfNullableInts : ?arg:'a141 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalMozMapOfNullableInts" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableBoolean : ?arg:Js.boolean Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableBoolean" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableBooleanWithDefault : ?arg:Js.boolean Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableBooleanWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableBooleanWithNonNullDefault : ?arg:Js.boolean Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableBooleanWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableByte : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableByte" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableByteString : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableByteString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableByteStringWithDefault : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableByteStringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableByteWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableByteWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableByteWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableByteWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableCallbackFunction : ?fun_:('a142 -> 'a143 [@bs]) Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableCallbackFunction" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableCallbackInterface : ?listener:(_) eventListener_like Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableCallbackInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableCallbackInterfaceWithDefault : ?listener:(_) eventListener_like Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableCallbackInterfaceWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableDouble : ?arg:float Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableFloat : ?arg:float Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableInterface : ?arg:(_) blob_like Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableInterfaceWithDefault : ?arg:(_) blob_like Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableInterfaceWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLong : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLongLong : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLongLongWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLongLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLongLongWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLongLongWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLongWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableLongWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableLongWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableMozMap : ?arg:'a144 Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableMozMapOfNullableInts : ?arg:'a145 Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableMozMapOfNullableInts" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableMozMapWithDefaultValue : ?arg:'a146 Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableMozMapWithDefaultValue" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableObject : ?arg:'a147 Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableObject" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableObjectWithDefault : ?arg:'a148 Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableObjectWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableOctet : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableOctet" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableOctetWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableOctetWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableOctetWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableOctetWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableSequence : ?seq:int array Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableShort : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableShortWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableShortWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableShortWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableShortWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableString : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableStringWithDefault : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableStringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableStringWithNonNullDefault : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableStringWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion : ?arg:'a149 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion2 : ?data:'a150 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion2WithDefault : ?data:'a151 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion2WithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion3 : ?arg:'a152 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion4 : ?data:'a153 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion5 : ?bool:'a154 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnion6 : ?arg:'a155 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnionWithDefault : ?arg:'a156 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnionWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnrestrictedDouble : ?arg:float Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnrestrictedFloat : ?arg:float Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLong : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLongLong : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLongLongWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLongLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLongLongWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLongLongWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLongWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedLongWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedLongWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedShort : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedShortWithDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedShortWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUnsignedShortWithNonNullDefault : ?arg:int Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUnsignedShortWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUsvstring : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUsvstring" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUsvstringWithDefault : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUsvstringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalNullableUsvstringWithNonNullDefault : ?arg:string Js.null Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalNullableUsvstringWithNonNullDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalObject : ?arg:'a157 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalObject" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalObjectMozMap : ?arg:'a158 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalObjectMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalOctet : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalOctet" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalOctetWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalOctetWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalSequence : ?seq:int array Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalShort : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalShortWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalShortWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalString : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalStringWithDefault : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalStringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion : ?arg:'a159 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion2 : ?data:'a160 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion3 : ?arg:'a161 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion4 : ?data:'a162 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion5 : ?bool:'a163 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnion6 : ?arg:'a164 Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnrestrictedDouble : ?arg:float Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnrestrictedFloat : ?arg:float Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedLong : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedLongLong : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedLongLongWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedLongLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedLongWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedLongWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedShort : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUnsignedShortWithDefault : ?arg:int Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUnsignedShortWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUsvstring : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUsvstring" [@@bs.send.pipe: ('own) testBinding_like] 
    external passOptionalUsvstringWithDefault : ?arg:string Js.undefined -> testBinding:('own) testBinding_like -> unit = "passOptionalUsvstringWithDefault" [@@bs.send.pipe: ('own) testBinding_like] 
    external passSequence : seq:int array -> testBinding:('own) testBinding_like -> unit = "passSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passSequenceSequence : seq:int array array -> testBinding:('own) testBinding_like -> unit = "passSequenceSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passShort : arg:int -> testBinding:('own) testBinding_like -> unit = "passShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passString : arg:string -> testBinding:('own) testBinding_like -> unit = "passString" [@@bs.send.pipe: ('own) testBinding_like] 
    external passStringMozMap : arg:'a165 -> testBinding:('own) testBinding_like -> unit = "passStringMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external passStringSequence : seq:string array -> testBinding:('own) testBinding_like -> unit = "passStringSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion : arg:'a166 -> testBinding:('own) testBinding_like -> unit = "passUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion10 : arg:'a167 -> testBinding:('own) testBinding_like -> unit = "passUnion10" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion2 : data:'a168 -> testBinding:('own) testBinding_like -> unit = "passUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion3 : data:'a169 -> testBinding:('own) testBinding_like -> unit = "passUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion4 : seq:'a170 -> testBinding:('own) testBinding_like -> unit = "passUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion5 : data:'a171 -> testBinding:('own) testBinding_like -> unit = "passUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion6 : bool:'a172 -> testBinding:('own) testBinding_like -> unit = "passUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion7 : arg:'a173 -> testBinding:('own) testBinding_like -> unit = "passUnion7" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion8 : arg:'a174 -> testBinding:('own) testBinding_like -> unit = "passUnion8" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnion9 : arg:'a175 -> testBinding:('own) testBinding_like -> unit = "passUnion9" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnionSequenceSequence : seq:'a176 -> testBinding:('own) testBinding_like -> unit = "passUnionSequenceSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnionWithTypedef : arg:'a177 -> testBinding:('own) testBinding_like -> unit = "passUnionWithTypedef" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnionWithTypedef2 : arg:'a178 -> testBinding:('own) testBinding_like -> unit = "passUnionWithTypedef2" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnrestrictedDouble : arg:float -> testBinding:('own) testBinding_like -> unit = "passUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnrestrictedFloat : arg:float -> testBinding:('own) testBinding_like -> unit = "passUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnsignedLong : arg:int -> testBinding:('own) testBinding_like -> unit = "passUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnsignedLongLong : arg:int -> testBinding:('own) testBinding_like -> unit = "passUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUnsignedShort : arg:int -> testBinding:('own) testBinding_like -> unit = "passUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external passUsvstring : arg:string -> testBinding:('own) testBinding_like -> unit = "passUsvstring" [@@bs.send.pipe: ('own) testBinding_like] 
    ...
    external prefControlledMethodDisabled : testBinding:('own) testBinding_like -> unit = "prefControlledMethodDisabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external prefControlledMethodEnabled : testBinding:('own) testBinding_like -> unit = "prefControlledMethodEnabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external prefControlledStaticMethodDisabled : testBinding:('own) testBinding_like -> unit = "prefControlledStaticMethodDisabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external prefControlledStaticMethodEnabled : testBinding:('own) testBinding_like -> unit = "prefControlledStaticMethodEnabled" [@@bs.send.pipe: ('own) testBinding_like] 
    external promiseNativeHandler : resolve:('a189 -> unit [@bs]) Js.null -> reject:('a190 -> unit [@bs]) Js.null -> testBinding:('own) testBinding_like -> 'a188 Js.Promise.t = "promiseNativeHandler" [@@bs.send.pipe: ('own) testBinding_like] 
    external promiseRejectNative : p:'a191 Js.Promise.t -> value:'a192 -> testBinding:('own) testBinding_like -> unit = "promiseRejectNative" [@@bs.send.pipe: ('own) testBinding_like] 
    external promiseRejectWithTypeError : p:'a193 Js.Promise.t -> message:string -> testBinding:('own) testBinding_like -> unit = "promiseRejectWithTypeError" [@@bs.send.pipe: ('own) testBinding_like] 
    external promiseResolveNative : p:'a194 Js.Promise.t -> value:'a195 -> testBinding:('own) testBinding_like -> unit = "promiseResolveNative" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveAny : testBinding:('own) testBinding_like -> 'a196 = "receiveAny" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveAnyMozMap : testBinding:('own) testBinding_like -> 'a197 = "receiveAnyMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveBoolean : testBinding:('own) testBinding_like -> bool = "receiveBoolean" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveByte : testBinding:('own) testBinding_like -> int = "receiveByte" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveByteString : testBinding:('own) testBinding_like -> string = "receiveByteString" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveDouble : testBinding:('own) testBinding_like -> float = "receiveDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveEnum : testBinding:('own) testBinding_like -> string = "receiveEnum" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveFloat : testBinding:('own) testBinding_like -> float = "receiveFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveInterface : testBinding:('own) testBinding_like -> blob = "receiveInterface" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveInterfaceSequence : testBinding:('own) testBinding_like -> blob array = "receiveInterfaceSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveLong : testBinding:('own) testBinding_like -> int = "receiveLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveLongLong : testBinding:('own) testBinding_like -> int = "receiveLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveMozMap : testBinding:('own) testBinding_like -> 'a198 = "receiveMozMap" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveMozMapOfMozMaps : testBinding:('own) testBinding_like -> 'a199 = "receiveMozMapOfMozMaps" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveMozMapOfNullableInts : testBinding:('own) testBinding_like -> 'a200 = "receiveMozMapOfNullableInts" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableBoolean : testBinding:('own) testBinding_like -> Js.boolean option = "receiveNullableBoolean" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableByte : testBinding:('own) testBinding_like -> int option = "receiveNullableByte" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableByteString : testBinding:('own) testBinding_like -> string option = "receiveNullableByteString" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableDouble : testBinding:('own) testBinding_like -> float option = "receiveNullableDouble" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableEnum : testBinding:('own) testBinding_like -> string option = "receiveNullableEnum" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableFloat : testBinding:('own) testBinding_like -> float option = "receiveNullableFloat" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableInterface : testBinding:('own) testBinding_like -> blob option = "receiveNullableInterface" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableLong : testBinding:('own) testBinding_like -> int option = "receiveNullableLong" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableLongLong : testBinding:('own) testBinding_like -> int option = "receiveNullableLongLong" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableMozMap : testBinding:('own) testBinding_like -> 'a201 option = "receiveNullableMozMap" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableMozMapOfNullableInts : testBinding:('own) testBinding_like -> 'a202 option = "receiveNullableMozMapOfNullableInts" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableObject : testBinding:('own) testBinding_like -> 'a203 option = "receiveNullableObject" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableOctet : testBinding:('own) testBinding_like -> int option = "receiveNullableOctet" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableSequence : testBinding:('own) testBinding_like -> int array option = "receiveNullableSequence" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableShort : testBinding:('own) testBinding_like -> int option = "receiveNullableShort" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableString : testBinding:('own) testBinding_like -> string option = "receiveNullableString" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUnion : testBinding:('own) testBinding_like -> 'a204 = "receiveNullableUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnion2 : testBinding:('own) testBinding_like -> 'a205 = "receiveNullableUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnion3 : testBinding:('own) testBinding_like -> 'a206 = "receiveNullableUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnion4 : testBinding:('own) testBinding_like -> 'a207 = "receiveNullableUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnion5 : testBinding:('own) testBinding_like -> 'a208 = "receiveNullableUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnion6 : testBinding:('own) testBinding_like -> 'a209 = "receiveNullableUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveNullableUnrestrictedDouble : testBinding:('own) testBinding_like -> float option = "receiveNullableUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUnrestrictedFloat : testBinding:('own) testBinding_like -> float option = "receiveNullableUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUnsignedLong : testBinding:('own) testBinding_like -> int option = "receiveNullableUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUnsignedLongLong : testBinding:('own) testBinding_like -> int option = "receiveNullableUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUnsignedShort : testBinding:('own) testBinding_like -> int option = "receiveNullableUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveNullableUsvstring : testBinding:('own) testBinding_like -> string option = "receiveNullableUsvstring" [@@bs.send.pipe: ('own) testBinding_like] [@@bs.return null_to_opt]
    external receiveObject : testBinding:('own) testBinding_like -> 'a210 = "receiveObject" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveOctet : testBinding:('own) testBinding_like -> int = "receiveOctet" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveSequence : testBinding:('own) testBinding_like -> int array = "receiveSequence" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveShort : testBinding:('own) testBinding_like -> int = "receiveShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveString : testBinding:('own) testBinding_like -> string = "receiveString" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveTestDictionaryWithSuccessOnKeyword : testBinding:('own) testBinding_like -> testDictionary = "receiveTestDictionaryWithSuccessOnKeyword" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion : testBinding:('own) testBinding_like -> 'a211 = "receiveUnion" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion10 : testBinding:('own) testBinding_like -> 'a212 = "receiveUnion10" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion11 : testBinding:('own) testBinding_like -> 'a213 = "receiveUnion11" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion2 : testBinding:('own) testBinding_like -> 'a214 = "receiveUnion2" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion3 : testBinding:('own) testBinding_like -> 'a215 = "receiveUnion3" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion4 : testBinding:('own) testBinding_like -> 'a216 = "receiveUnion4" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion5 : testBinding:('own) testBinding_like -> 'a217 = "receiveUnion5" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion6 : testBinding:('own) testBinding_like -> 'a218 = "receiveUnion6" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion7 : testBinding:('own) testBinding_like -> 'a219 = "receiveUnion7" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion8 : testBinding:('own) testBinding_like -> 'a220 = "receiveUnion8" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnion9 : testBinding:('own) testBinding_like -> 'a221 = "receiveUnion9" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnrestrictedDouble : testBinding:('own) testBinding_like -> float = "receiveUnrestrictedDouble" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnrestrictedFloat : testBinding:('own) testBinding_like -> float = "receiveUnrestrictedFloat" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnsignedLong : testBinding:('own) testBinding_like -> int = "receiveUnsignedLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnsignedLongLong : testBinding:('own) testBinding_like -> int = "receiveUnsignedLongLong" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUnsignedShort : testBinding:('own) testBinding_like -> int = "receiveUnsignedShort" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveUsvstring : testBinding:('own) testBinding_like -> string = "receiveUsvstring" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveVoid : testBinding:('own) testBinding_like -> unit = "receiveVoid" [@@bs.send.pipe: ('own) testBinding_like] 
    external receiveVoidStatic : testBinding:('own) testBinding_like -> unit = "receiveVoidStatic" [@@bs.send.pipe: ('own) testBinding_like] 
    external resolvePromiseDelayed : p:'a222 Js.Promise.t -> value:string -> ms:int -> testBinding:('own) testBinding_like -> unit = "resolvePromiseDelayed" [@@bs.send.pipe: ('own) testBinding_like] 
    external returnRejectedPromise : value:'a224 -> testBinding:('own) testBinding_like -> 'a223 Js.Promise.t = "returnRejectedPromise" [@@bs.send.pipe: ('own) testBinding_like] 
    external returnResolvedPromise : value:'a226 -> testBinding:('own) testBinding_like -> 'a225 Js.Promise.t = "returnResolvedPromise" [@@bs.send.pipe: ('own) testBinding_like] 
    external returnSequenceSequence : testBinding:('own) testBinding_like -> int array array = "returnSequenceSequence" [@@bs.send.pipe: ('own) testBinding_like] 
 ...
 module WorkerLocation = struct
    ...
    external toString : workerLocation:('own) workerLocation_like -> string = "toString" [@@bs.send.pipe: ('own) workerLocation_like] 
 ...
 module CSS = struct
    ...
    external escape : ident:string -> cSS:('own) cSS_like -> string = "escape" [@@bs.send.pipe: ('own) cSS_like] 
    external supports : property:string -> value:string -> cSS:('own) cSS_like -> bool = "supports" [@@bs.send.pipe: ('own) cSS_like] 
 ...
 module CanvasGradient = struct
    ...
    external addColorStop : offset:float -> color:string -> canvasGradient:('own) canvasGradient_like -> unit = "addColorStop" [@@bs.send.pipe: ('own) canvasGradient_like] 
 ...
 module TextDecoder = struct
    ...
    external decode : ?input:'a235 Js.undefined -> textDecoder:('own) textDecoder_like -> string = "decode" [@@bs.send.pipe: ('own) textDecoder_like] 
 ...
 module TestBindingPairIterable = struct
    ...
    external add : key:string -> value:int -> testBindingPairIterable:('own) testBindingPairIterable_like -> unit = "add" [@@bs.send.pipe: ('own) testBindingPairIterable_like] 
 ...
 module HTMLHyperlinkElementUtils = struct
    ...
    external toString : hTMLHyperlinkElementUtils:('own) hTMLHyperlinkElementUtils_like -> string = "toString" [@@bs.send.pipe: ('own) hTMLHyperlinkElementUtils_like] 
 ...
 module NamedNodeMap = struct
    ...
    external getNamedItem : qualifiedName:string -> namedNodeMap:('own) namedNodeMap_like -> attr option = "getNamedItem" [@@bs.send.pipe: ('own) namedNodeMap_like] [@@bs.return null_to_opt]
    external getNamedItemNS : namespace:string Js.null -> localName:string -> namedNodeMap:('own) namedNodeMap_like -> attr option = "getNamedItemNS" [@@bs.send.pipe: ('own) namedNodeMap_like] [@@bs.return null_to_opt]
    external item : index:int -> namedNodeMap:('own) namedNodeMap_like -> attr option = "item" [@@bs.send.pipe: ('own) namedNodeMap_like] [@@bs.return null_to_opt]
    external removeNamedItem : qualifiedName:string -> namedNodeMap:('own) namedNodeMap_like -> attr = "removeNamedItem" [@@bs.send.pipe: ('own) namedNodeMap_like] 
    external removeNamedItemNS : namespace:string Js.null -> localName:string -> namedNodeMap:('own) namedNodeMap_like -> attr = "removeNamedItemNS" [@@bs.send.pipe: ('own) namedNodeMap_like] 
    external setNamedItem : attr:(_) attr_like -> namedNodeMap:('own) namedNodeMap_like -> attr option = "setNamedItem" [@@bs.send.pipe: ('own) namedNodeMap_like] [@@bs.return null_to_opt]
    external setNamedItemNS : attr:(_) attr_like -> namedNodeMap:('own) namedNodeMap_like -> attr option = "setNamedItemNS" [@@bs.send.pipe: ('own) namedNodeMap_like] [@@bs.return null_to_opt]
 ...
 module TouchList = struct
    ...
    external item : index:int -> touchList:('own) touchList_like -> touch option = "item" [@@bs.send.pipe: ('own) touchList_like] [@@bs.return null_to_opt]
 ...
 module Plugin = struct
    ...
    external item : index:int -> plugin:('own) plugin_like -> mimeType option = "item" [@@bs.send.pipe: ('own) plugin_like] [@@bs.return null_to_opt]
    external namedItem : name:string -> plugin:('own) plugin_like -> mimeType option = "namedItem" [@@bs.send.pipe: ('own) plugin_like] [@@bs.return null_to_opt]
 ...
 module Headers = struct
    ...
    external append : name:string -> value:string -> headers:('own) headers_like -> unit = "append" [@@bs.send.pipe: ('own) headers_like] 
    external delete : name:string -> headers:('own) headers_like -> unit = "delete" [@@bs.send.pipe: ('own) headers_like] 
    external get : name:string -> headers:('own) headers_like -> string option = "get" [@@bs.send.pipe: ('own) headers_like] [@@bs.return null_to_opt]
    external has : name:string -> headers:('own) headers_like -> bool = "has" [@@bs.send.pipe: ('own) headers_like] 
    external set : name:string -> value:string -> headers:('own) headers_like -> unit = "set" [@@bs.send.pipe: ('own) headers_like] 
 ...
 module Worklet = struct
    ...
    external addModule : moduleURL:string -> ?options:(_) workletOptions_like Js.undefined -> worklet:('own) worklet_like -> unit Js.Promise.t = "addModule" [@@bs.send.pipe: ('own) worklet_like] 
 ...
 module Navigator = struct
    ...
    external getGamepads : navigator:('own) navigator_like -> gamepadList = "getGamepads" [@@bs.send.pipe: ('own) navigator_like] 
    external javaEnabled : navigator:('own) navigator_like -> bool = "javaEnabled" [@@bs.send.pipe: ('own) navigator_like] 
    external taintEnabled : navigator:('own) navigator_like -> bool = "taintEnabled" [@@bs.send.pipe: ('own) navigator_like] 
 ...
 module NavigatorID = struct
    ...
    external taintEnabled : navigatorID:('own) navigatorID_like -> bool = "taintEnabled" [@@bs.send.pipe: ('own) navigatorID_like] 
 ...
 module NavigatorPlugins = struct
    ...
    external javaEnabled : navigatorPlugins:('own) navigatorPlugins_like -> bool = "javaEnabled" [@@bs.send.pipe: ('own) navigatorPlugins_like] 
 ...
 module Crypto = struct
    ...
    external getRandomValues : array:'a237 -> crypto:('own) crypto_like -> 'a236 = "getRandomValues" [@@bs.send.pipe: ('own) crypto_like] 
 ...
 module CSSStyleDeclaration = struct
    ...
    external getPropertyPriority : property:string -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> string = "getPropertyPriority" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external getPropertyValue : property:string -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> string = "getPropertyValue" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external item : index:int -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> string = "item" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external removeProperty : property:string -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> string = "removeProperty" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external setProperty : property:string -> value:string -> ?priority:string Js.undefined -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> unit = "setProperty" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external setPropertyPriority : property:string -> priority:string -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> unit = "setPropertyPriority" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
    external setPropertyValue : property:string -> value:string -> cSSStyleDeclaration:('own) cSSStyleDeclaration_like -> unit = "setPropertyValue" [@@bs.send.pipe: ('own) cSSStyleDeclaration_like] 
 ...
 module DOMQuad = struct
    ...
    external fromQuad : ?other:(_) dOMQuadInit_like Js.undefined -> dOMQuad:('own) dOMQuad_like -> dOMQuad = "fromQuad" [@@bs.send.pipe: ('own) dOMQuad_like] 
    external fromRect : ?other:(_) dOMRectInit_like Js.undefined -> dOMQuad:('own) dOMQuad_like -> dOMQuad = "fromRect" [@@bs.send.pipe: ('own) dOMQuad_like] 
    external getBounds : dOMQuad:('own) dOMQuad_like -> dOMRect = "getBounds" [@@bs.send.pipe: ('own) dOMQuad_like] 
 ...
 module Request = struct
    ...
    external blob : request:('own) request_like -> blob Js.Promise.t = "blob" [@@bs.send.pipe: ('own) request_like] 
    external clone : request:('own) request_like -> request = "clone" [@@bs.send.pipe: ('own) request_like] 
    external formData : request:('own) request_like -> formData Js.Promise.t = "formData" [@@bs.send.pipe: ('own) request_like] 
    external json : request:('own) request_like -> 'a238 Js.Promise.t = "json" [@@bs.send.pipe: ('own) request_like] 
    external text : request:('own) request_like -> string Js.Promise.t = "text" [@@bs.send.pipe: ('own) request_like] 
 ...
 module DOMTokenList = struct
    ...
    external contains : token:string -> dOMTokenList:('own) dOMTokenList_like -> bool = "contains" [@@bs.send.pipe: ('own) dOMTokenList_like] 
    external item : index:int -> dOMTokenList:('own) dOMTokenList_like -> string option = "item" [@@bs.send.pipe: ('own) dOMTokenList_like] [@@bs.return null_to_opt]
    external remove : dOMTokenList:('own) dOMTokenList_like -> (('own) dOMTokenList_like, unit, (string)) variadic_func = "remove" [@@bs.get]
    external replace : token:string -> newToken:string -> dOMTokenList:('own) dOMTokenList_like -> unit = "replace" [@@bs.send.pipe: ('own) dOMTokenList_like] 
    external toString : dOMTokenList:('own) dOMTokenList_like -> string = "toString" [@@bs.send.pipe: ('own) dOMTokenList_like] 
    external toggle : token:string -> ?force:Js.boolean Js.undefined -> dOMTokenList:('own) dOMTokenList_like -> bool = "toggle" [@@bs.send.pipe: ('own) dOMTokenList_like] 
 ...
 module GamepadButtonList = struct
    ...
    external item : index:int -> gamepadButtonList:('own) gamepadButtonList_like -> gamepadButton option = "item" [@@bs.send.pipe: ('own) gamepadButtonList_like] [@@bs.return null_to_opt]
 ...
 module Response = struct
    ...
    external blob : response:('own) response_like -> blob Js.Promise.t = "blob" [@@bs.send.pipe: ('own) response_like] 
    external clone : response:('own) response_like -> response = "clone" [@@bs.send.pipe: ('own) response_like] 
    external error : response:('own) response_like -> response = "error" [@@bs.send.pipe: ('own) response_like] 
    external formData : response:('own) response_like -> formData Js.Promise.t = "formData" [@@bs.send.pipe: ('own) response_like] 
    external json : response:('own) response_like -> 'a239 Js.Promise.t = "json" [@@bs.send.pipe: ('own) response_like] 
    external redirect : url:string -> ?status:int Js.undefined -> response:('own) response_like -> response = "redirect" [@@bs.send.pipe: ('own) response_like] 
    external text : response:('own) response_like -> string Js.Promise.t = "text" [@@bs.send.pipe: ('own) response_like] 
 ...
 module TestWorklet = struct
    ...
    external addModule : moduleURL:string -> ?options:(_) workletOptions_like Js.undefined -> testWorklet:('own) testWorklet_like -> unit Js.Promise.t = "addModule" [@@bs.send.pipe: ('own) testWorklet_like] 
    external lookup : key:string -> testWorklet:('own) testWorklet_like -> string option = "lookup" [@@bs.send.pipe: ('own) testWorklet_like] [@@bs.return null_to_opt]
 ...
 module BluetoothUUID = struct
    ...
    external canonicalUUID : alias:int -> bluetoothUUID:('own) bluetoothUUID_like -> string = "canonicalUUID" [@@bs.send.pipe: ('own) bluetoothUUID_like] 
    external getCharacteristic : name:'a242 -> bluetoothUUID:('own) bluetoothUUID_like -> string = "getCharacteristic" [@@bs.send.pipe: ('own) bluetoothUUID_like] 
    external getDescriptor : name:'a243 -> bluetoothUUID:('own) bluetoothUUID_like -> string = "getDescriptor" [@@bs.send.pipe: ('own) bluetoothUUID_like] 
    external getService : name:'a244 -> bluetoothUUID:('own) bluetoothUUID_like -> string = "getService" [@@bs.send.pipe: ('own) bluetoothUUID_like] 
 ...
 module CanvasRenderingContext2D = struct
    ...
    external arc : x:float -> y:float -> radius:float -> startAngle:float -> endAngle:float -> ?anticlockwise:Js.boolean Js.undefined -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "arc" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external arcTo : x1:float -> y1:float -> x2:float -> y2:float -> radius:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "arcTo" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external beginPath : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "beginPath" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external bezierCurveTo : cp1x:float -> cp1y:float -> cp2x:float -> cp2y:float -> x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "bezierCurveTo" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external clearRect : x:float -> y:float -> w:float -> h:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "clearRect" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external clip : ?fillRule:string Js.undefined -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "clip" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external closePath : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "closePath" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external createImageData : sw:float -> sh:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> imageData = "createImageData" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external createLinearGradient : x0:float -> y0:float -> x1:float -> y1:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> canvasGradient = "createLinearGradient" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external createPattern : image:'a249 -> repetition:string -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> canvasPattern = "createPattern" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external createRadialGradient : x0:float -> y0:float -> r0:float -> x1:float -> y1:float -> r1:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> canvasGradient = "createRadialGradient" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external drawImage : image:'a250 -> dx:float -> dy:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "drawImage" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external fill : ?fillRule:string Js.undefined -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "fill" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external fillRect : x:float -> y:float -> w:float -> h:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "fillRect" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external getImageData : sx:float -> sy:float -> sw:float -> sh:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> imageData = "getImageData" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external isPointInPath : x:float -> y:float -> ?fillRule:string Js.undefined -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> bool = "isPointInPath" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external lineTo : x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "lineTo" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external moveTo : x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "moveTo" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external putImageData : imagedata:(_) imageData_like -> dx:float -> dy:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "putImageData" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external quadraticCurveTo : cpx:float -> cpy:float -> x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "quadraticCurveTo" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external rect : x:float -> y:float -> w:float -> h:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "rect" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external resetTransform : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "resetTransform" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external restore : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "restore" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external rotate : angle:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "rotate" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external save : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "save" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external scale : x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "scale" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external setTransform : a:float -> b:float -> c:float -> d:float -> e:float -> f:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "setTransform" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external stroke : canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "stroke" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external strokeRect : x:float -> y:float -> w:float -> h:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "strokeRect" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external transform : a:float -> b:float -> c:float -> d:float -> e:float -> f:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "transform" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
    external translate : x:float -> y:float -> canvasRenderingContext2D:('own) canvasRenderingContext2D_like -> unit = "translate" [@@bs.send.pipe: ('own) canvasRenderingContext2D_like] 
 ...
 module CanvasState = struct
    ...
    external restore : canvasState:('own) canvasState_like -> unit = "restore" [@@bs.send.pipe: ('own) canvasState_like] 
    external save : canvasState:('own) canvasState_like -> unit = "save" [@@bs.send.pipe: ('own) canvasState_like] 
 ...
 module CanvasTransform = struct
    ...
    external resetTransform : canvasTransform:('own) canvasTransform_like -> unit = "resetTransform" [@@bs.send.pipe: ('own) canvasTransform_like] 
    external rotate : angle:float -> canvasTransform:('own) canvasTransform_like -> unit = "rotate" [@@bs.send.pipe: ('own) canvasTransform_like] 
    external scale : x:float -> y:float -> canvasTransform:('own) canvasTransform_like -> unit = "scale" [@@bs.send.pipe: ('own) canvasTransform_like] 
    external setTransform : a:float -> b:float -> c:float -> d:float -> e:float -> f:float -> canvasTransform:('own) canvasTransform_like -> unit = "setTransform" [@@bs.send.pipe: ('own) canvasTransform_like] 
    external transform : a:float -> b:float -> c:float -> d:float -> e:float -> f:float -> canvasTransform:('own) canvasTransform_like -> unit = "transform" [@@bs.send.pipe: ('own) canvasTransform_like] 
    external translate : x:float -> y:float -> canvasTransform:('own) canvasTransform_like -> unit = "translate" [@@bs.send.pipe: ('own) canvasTransform_like] 
 ...
 module CanvasFillStrokeStyles = struct
    ...
    external createLinearGradient : x0:float -> y0:float -> x1:float -> y1:float -> canvasFillStrokeStyles:('own) canvasFillStrokeStyles_like -> canvasGradient = "createLinearGradient" [@@bs.send.pipe: ('own) canvasFillStrokeStyles_like] 
    external createPattern : image:'a255 -> repetition:string -> canvasFillStrokeStyles:('own) canvasFillStrokeStyles_like -> canvasPattern = "createPattern" [@@bs.send.pipe: ('own) canvasFillStrokeStyles_like] 
    external createRadialGradient : x0:float -> y0:float -> r0:float -> x1:float -> y1:float -> r1:float -> canvasFillStrokeStyles:('own) canvasFillStrokeStyles_like -> canvasGradient = "createRadialGradient" [@@bs.send.pipe: ('own) canvasFillStrokeStyles_like] 
 ...
 module CanvasRect = struct
    ...
    external clearRect : x:float -> y:float -> w:float -> h:float -> canvasRect:('own) canvasRect_like -> unit = "clearRect" [@@bs.send.pipe: ('own) canvasRect_like] 
    external fillRect : x:float -> y:float -> w:float -> h:float -> canvasRect:('own) canvasRect_like -> unit = "fillRect" [@@bs.send.pipe: ('own) canvasRect_like] 
    external strokeRect : x:float -> y:float -> w:float -> h:float -> canvasRect:('own) canvasRect_like -> unit = "strokeRect" [@@bs.send.pipe: ('own) canvasRect_like] 
 ...
 module CanvasDrawPath = struct
    ...
    external beginPath : canvasDrawPath:('own) canvasDrawPath_like -> unit = "beginPath" [@@bs.send.pipe: ('own) canvasDrawPath_like] 
    external clip : ?fillRule:string Js.undefined -> canvasDrawPath:('own) canvasDrawPath_like -> unit = "clip" [@@bs.send.pipe: ('own) canvasDrawPath_like] 
    external fill : ?fillRule:string Js.undefined -> canvasDrawPath:('own) canvasDrawPath_like -> unit = "fill" [@@bs.send.pipe: ('own) canvasDrawPath_like] 
    external isPointInPath : x:float -> y:float -> ?fillRule:string Js.undefined -> canvasDrawPath:('own) canvasDrawPath_like -> bool = "isPointInPath" [@@bs.send.pipe: ('own) canvasDrawPath_like] 
    external stroke : canvasDrawPath:('own) canvasDrawPath_like -> unit = "stroke" [@@bs.send.pipe: ('own) canvasDrawPath_like] 
 ...
 module CanvasDrawImage = struct
    ...
    external drawImage : image:'a256 -> dx:float -> dy:float -> canvasDrawImage:('own) canvasDrawImage_like -> unit = "drawImage" [@@bs.send.pipe: ('own) canvasDrawImage_like] 
 ...
 module CanvasImageData = struct
    ...
    external createImageData : sw:float -> sh:float -> canvasImageData:('own) canvasImageData_like -> imageData = "createImageData" [@@bs.send.pipe: ('own) canvasImageData_like] 
    external getImageData : sx:float -> sy:float -> sw:float -> sh:float -> canvasImageData:('own) canvasImageData_like -> imageData = "getImageData" [@@bs.send.pipe: ('own) canvasImageData_like] 
    external putImageData : imagedata:(_) imageData_like -> dx:float -> dy:float -> canvasImageData:('own) canvasImageData_like -> unit = "putImageData" [@@bs.send.pipe: ('own) canvasImageData_like] 
 ...
 module CanvasPath = struct
    ...
    external arc : x:float -> y:float -> radius:float -> startAngle:float -> endAngle:float -> ?anticlockwise:Js.boolean Js.undefined -> canvasPath:('own) canvasPath_like -> unit = "arc" [@@bs.send.pipe: ('own) canvasPath_like] 
    external arcTo : x1:float -> y1:float -> x2:float -> y2:float -> radius:float -> canvasPath:('own) canvasPath_like -> unit = "arcTo" [@@bs.send.pipe: ('own) canvasPath_like] 
    external bezierCurveTo : cp1x:float -> cp1y:float -> cp2x:float -> cp2y:float -> x:float -> y:float -> canvasPath:('own) canvasPath_like -> unit = "bezierCurveTo" [@@bs.send.pipe: ('own) canvasPath_like] 
    external closePath : canvasPath:('own) canvasPath_like -> unit = "closePath" [@@bs.send.pipe: ('own) canvasPath_like] 
    external lineTo : x:float -> y:float -> canvasPath:('own) canvasPath_like -> unit = "lineTo" [@@bs.send.pipe: ('own) canvasPath_like] 
    external moveTo : x:float -> y:float -> canvasPath:('own) canvasPath_like -> unit = "moveTo" [@@bs.send.pipe: ('own) canvasPath_like] 
    external quadraticCurveTo : cpx:float -> cpy:float -> x:float -> y:float -> canvasPath:('own) canvasPath_like -> unit = "quadraticCurveTo" [@@bs.send.pipe: ('own) canvasPath_like] 
    external rect : x:float -> y:float -> w:float -> h:float -> canvasPath:('own) canvasPath_like -> unit = "rect" [@@bs.send.pipe: ('own) canvasPath_like] 
 ...
 module MediaList = struct
    ...
    external appendMedium : medium:string -> mediaList:('own) mediaList_like -> unit = "appendMedium" [@@bs.send.pipe: ('own) mediaList_like] 
    external deleteMedium : medium:string -> mediaList:('own) mediaList_like -> unit = "deleteMedium" [@@bs.send.pipe: ('own) mediaList_like] 
    external item : index:int -> mediaList:('own) mediaList_like -> string option = "item" [@@bs.send.pipe: ('own) mediaList_like] [@@bs.return null_to_opt]
 ...
 module Permissions = struct
    ...
    external query : permissionDesc:'a257 -> permissions:('own) permissions_like -> permissionStatus Js.Promise.t = "query" [@@bs.send.pipe: ('own) permissions_like] 
    external request : permissionDesc:'a258 -> permissions:('own) permissions_like -> permissionStatus Js.Promise.t = "request" [@@bs.send.pipe: ('own) permissions_like] 
    external revoke : permissionDesc:'a259 -> permissions:('own) permissions_like -> permissionStatus Js.Promise.t = "revoke" [@@bs.send.pipe: ('own) permissions_like] 
 ...
 module Storage = struct
    ...
    external clear : storage:('own) storage_like -> unit = "clear" [@@bs.send.pipe: ('own) storage_like] 
    external getItem : name:string -> storage:('own) storage_like -> string option = "getItem" [@@bs.send.pipe: ('own) storage_like] [@@bs.return null_to_opt]
    external key : index:int -> storage:('own) storage_like -> string option = "key" [@@bs.send.pipe: ('own) storage_like] [@@bs.return null_to_opt]
    external removeItem : name:string -> storage:('own) storage_like -> unit = "removeItem" [@@bs.send.pipe: ('own) storage_like] 
    external setItem : name:string -> value:string -> storage:('own) storage_like -> unit = "setItem" [@@bs.send.pipe: ('own) storage_like] 
 ...
 module MutationObserver = struct
    ...
    external observe : target:(_) node_like -> ?options:(_) mutationObserverInit_like Js.undefined -> mutationObserver:('own) mutationObserver_like -> unit = "observe" [@@bs.send.pipe: ('own) mutationObserver_like] 
 ...
 module TestBindingIterable = struct
    ...
    external add : arg:string -> testBindingIterable:('own) testBindingIterable_like -> unit = "add" [@@bs.send.pipe: ('own) testBindingIterable_like] 
    external getItem : index:int -> testBindingIterable:('own) testBindingIterable_like -> string = "getItem" [@@bs.send.pipe: ('own) testBindingIterable_like] 
 ...
 module TextEncoder = struct
    ...
    external encode : ?input:string Js.undefined -> textEncoder:('own) textEncoder_like -> Js_typed_array.Uint8Array.t = "encode" [@@bs.send.pipe: ('own) textEncoder_like] 
 ...
 module Event = struct
    ...
    external initEvent : type_:string -> bubbles:Js.boolean -> cancelable:Js.boolean -> event:('own) event_like -> unit = "initEvent" [@@bs.send.pipe: ('own) event_like] 
    external preventDefault : event:('own) event_like -> unit = "preventDefault" [@@bs.send.pipe: ('own) event_like] 
    external stopImmediatePropagation : event:('own) event_like -> unit = "stopImmediatePropagation" [@@bs.send.pipe: ('own) event_like] 
    external stopPropagation : event:('own) event_like -> unit = "stopPropagation" [@@bs.send.pipe: ('own) event_like] 
 ...
 module WindowTimers = struct
    ...
    external clearInterval : ?handle:int Js.undefined -> windowTimers:('own) windowTimers_like -> unit = "clearInterval" [@@bs.send.pipe: ('own) windowTimers_like] 
    external clearTimeout : ?handle:int Js.undefined -> windowTimers:('own) windowTimers_like -> unit = "clearTimeout" [@@bs.send.pipe: ('own) windowTimers_like] 
 ...
 module WindowBase64 = struct
    ...
    external atob : atob:string -> windowBase64:('own) windowBase64_like -> string = "atob" [@@bs.send.pipe: ('own) windowBase64_like] 
    external btoa : btoa:string -> windowBase64:('own) windowBase64_like -> string = "btoa" [@@bs.send.pipe: ('own) windowBase64_like] 
 ...
 module DOMStringMap = struct
    ...
    external none : name:string -> dOMStringMap:('own) dOMStringMap_like -> string = "" [@@bs.get_index] 
    external none : name:string -> value:string -> dOMStringMap:('own) dOMStringMap_like -> unit = "" [@@bs.set_index] 
    external none : name:string -> dOMStringMap:('own) dOMStringMap_like -> unit = "" [@@bs.get_index] 
 ...
 module Blob = struct
    ...
    external slice : ?start:int Js.undefined -> ?end_:int Js.undefined -> ?contentType:string Js.undefined -> blob:('own) blob_like -> blob = "slice" [@@bs.send.pipe: ('own) blob_like] 
 ...
 module ActivatableElement = struct
    ...
    external enterFormalActivationState : activatableElement:('own) activatableElement_like -> unit = "enterFormalActivationState" [@@bs.send.pipe: ('own) activatableElement_like] 
    external exitFormalActivationState : activatableElement:('own) activatableElement_like -> unit = "exitFormalActivationState" [@@bs.send.pipe: ('own) activatableElement_like] 
 ...
 module StyleSheetList = struct
    ...
    external item : index:int -> styleSheetList:('own) styleSheetList_like -> styleSheet option = "item" [@@bs.send.pipe: ('own) styleSheetList_like] [@@bs.return null_to_opt]
 ...
 module NodeFilter = struct
    ...
    external acceptNode : node:(_) node_like -> nodeFilter:('own) nodeFilter_like -> int = "acceptNode" [@@bs.send.pipe: ('own) nodeFilter_like] 
 ...
 module EventListener = struct
    ...
    external handleEvent : event:(_) event_like -> eventListener:('own) eventListener_like -> unit = "handleEvent" [@@bs.send.pipe: ('own) eventListener_like] 
 ...
 module EventSource = struct
    ...
    external close : eventSource:('own) eventSource_like -> unit = "close" [@@bs.send.pipe: ('own) eventSource_like] 
 ...
 module UIEvent = struct
    ...
    external initUIEvent : typeArg:string -> bubblesArg:Js.boolean -> cancelableArg:Js.boolean -> viewArg:(_) window_like Js.null -> detailArg:int -> uIEvent:('own) uIEvent_like -> unit = "initUIEvent" [@@bs.send.pipe: ('own) uIEvent_like] 
 ...
 module HTMLOptionsCollection = struct
    ...
    external none : index:int -> option:(_) hTMLOptionElement_like Js.null -> hTMLOptionsCollection:('own) hTMLOptionsCollection_like -> unit = "" [@@bs.set_index] 
    external add : element:'a482 -> ?before:'a483 Js.undefined -> hTMLOptionsCollection:('own) hTMLOptionsCollection_like -> unit = "add" [@@bs.send.pipe: ('own) hTMLOptionsCollection_like] 
    external remove : index:int -> hTMLOptionsCollection:('own) hTMLOptionsCollection_like -> unit = "remove" [@@bs.send.pipe: ('own) hTMLOptionsCollection_like] 
 ...
 module DOMMatrix = struct
    ...
    external fromMatrix : ?other:(_) dOMMatrixInit_like Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "fromMatrix" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external invertSelf : dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "invertSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external multiplySelf : ?other:(_) dOMMatrixInit_like Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "multiplySelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external preMultiplySelf : ?other:(_) dOMMatrixInit_like Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "preMultiplySelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external rotateAxisAngleSelf : ?x:float Js.undefined -> ?y:float Js.undefined -> ?z:float Js.undefined -> ?angle:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "rotateAxisAngleSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external rotateFromVectorSelf : ?x:float Js.undefined -> ?y:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "rotateFromVectorSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external rotateSelf : ?rotX:float Js.undefined -> ?rotY:float Js.undefined -> ?rotZ:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "rotateSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external scale3dSelf : ?scale:float Js.undefined -> ?originX:float Js.undefined -> ?originY:float Js.undefined -> ?originZ:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "scale3dSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external scaleSelf : ?scaleX:float Js.undefined -> ?scaleY:float Js.undefined -> ?scaleZ:float Js.undefined -> ?originX:float Js.undefined -> ?originY:float Js.undefined -> ?originZ:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "scaleSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external skewXSelf : ?sx:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "skewXSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external skewYSelf : ?sy:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "skewYSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
    external translateSelf : ?tx:float Js.undefined -> ?ty:float Js.undefined -> ?tz:float Js.undefined -> dOMMatrix:('own) dOMMatrix_like -> dOMMatrix = "translateSelf" [@@bs.send.pipe: ('own) dOMMatrix_like] 
 ...
 module ServiceWorkerContainer = struct
    ...
    external register : scriptURL:string -> ?options:(_) registrationOptions_like Js.undefined -> serviceWorkerContainer:('own) serviceWorkerContainer_like -> serviceWorkerRegistration Js.Promise.t = "register" [@@bs.send.pipe: ('own) serviceWorkerContainer_like] 
 ...
 module VR = struct
    ...
    external getDisplays : vR:('own) vR_like -> vRDisplay array Js.Promise.t = "getDisplays" [@@bs.send.pipe: ('own) vR_like] 
 ...
 module BluetoothDevice = struct
    ...
    external unwatchAdvertisements : bluetoothDevice:('own) bluetoothDevice_like -> unit = "unwatchAdvertisements" [@@bs.send.pipe: ('own) bluetoothDevice_like] 
    external watchAdvertisements : bluetoothDevice:('own) bluetoothDevice_like -> unit Js.Promise.t = "watchAdvertisements" [@@bs.send.pipe: ('own) bluetoothDevice_like] 
 ...
 module Node = struct
    ...
    external appendChild : node:(_) node_like -> node:('own) node_like -> node = "appendChild" [@@bs.send.pipe: ('own) node_like] 
    external cloneNode : ?deep:Js.boolean Js.undefined -> node:('own) node_like -> node = "cloneNode" [@@bs.send.pipe: ('own) node_like] 
    external compareDocumentPosition : other:(_) node_like -> node:('own) node_like -> int = "compareDocumentPosition" [@@bs.send.pipe: ('own) node_like] 
    external contains : other:(_) node_like Js.null -> node:('own) node_like -> bool = "contains" [@@bs.send.pipe: ('own) node_like] 
    external getRootNode : node:('own) node_like -> node = "getRootNode" [@@bs.send.pipe: ('own) node_like] 
    external hasChildNodes : node:('own) node_like -> bool = "hasChildNodes" [@@bs.send.pipe: ('own) node_like] 
    external insertBefore : node:(_) node_like -> child:(_) node_like Js.null -> node:('own) node_like -> node = "insertBefore" [@@bs.send.pipe: ('own) node_like] 
    external isDefaultNamespace : namespace:string Js.null -> node:('own) node_like -> bool = "isDefaultNamespace" [@@bs.send.pipe: ('own) node_like] 
    external isEqualNode : node:(_) node_like Js.null -> node:('own) node_like -> bool = "isEqualNode" [@@bs.send.pipe: ('own) node_like] 
    external isSameNode : otherNode:(_) node_like Js.null -> node:('own) node_like -> bool = "isSameNode" [@@bs.send.pipe: ('own) node_like] 
    external lookupNamespaceURI : prefix:string Js.null -> node:('own) node_like -> string option = "lookupNamespaceURI" [@@bs.send.pipe: ('own) node_like] [@@bs.return null_to_opt]
    external lookupPrefix : namespace:string Js.null -> node:('own) node_like -> string option = "lookupPrefix" [@@bs.send.pipe: ('own) node_like] [@@bs.return null_to_opt]
    external normalize : node:('own) node_like -> unit = "normalize" [@@bs.send.pipe: ('own) node_like] 
    external removeChild : child:(_) node_like -> node:('own) node_like -> node = "removeChild" [@@bs.send.pipe: ('own) node_like] 
    external replaceChild : node:(_) node_like -> child:(_) node_like -> node:('own) node_like -> node = "replaceChild" [@@bs.send.pipe: ('own) node_like] 
 ...
 module VRDisplay = struct
    ...
    external cancelAnimationFrame : handle:int -> vRDisplay:('own) vRDisplay_like -> unit = "cancelAnimationFrame" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external exitPresent : vRDisplay:('own) vRDisplay_like -> unit Js.Promise.t = "exitPresent" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external getEyeParameters : whichEye:string -> vRDisplay:('own) vRDisplay_like -> vREyeParameters = "getEyeParameters" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external getFrameData : frameData:(_) vRFrameData_like -> vRDisplay:('own) vRDisplay_like -> bool = "getFrameData" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external getPose : vRDisplay:('own) vRDisplay_like -> vRPose = "getPose" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external requestAnimationFrame : callback:(float -> unit [@bs]) -> vRDisplay:('own) vRDisplay_like -> int = "requestAnimationFrame" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external requestPresent : layers:(_) vRLayer_like array -> vRDisplay:('own) vRDisplay_like -> unit Js.Promise.t = "requestPresent" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external resetPose : vRDisplay:('own) vRDisplay_like -> unit = "resetPose" [@@bs.send.pipe: ('own) vRDisplay_like] 
    external submitFrame : vRDisplay:('own) vRDisplay_like -> unit = "submitFrame" [@@bs.send.pipe: ('own) vRDisplay_like] 
 ...
 module BluetoothRemoteGATTCharacteristic = struct
    ...
    external getDescriptor : descriptor:'a493 -> bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> bluetoothRemoteGATTDescriptor Js.Promise.t = "getDescriptor" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
    external getDescriptors : ?descriptor:'a494 Js.undefined -> bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> bluetoothRemoteGATTDescriptor array Js.Promise.t = "getDescriptors" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
    external readValue : bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> string Js.Promise.t = "readValue" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
    external startNotifications : bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> bluetoothRemoteGATTCharacteristic Js.Promise.t = "startNotifications" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
    external stopNotifications : bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> bluetoothRemoteGATTCharacteristic Js.Promise.t = "stopNotifications" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
    external writeValue : value:int array -> bluetoothRemoteGATTCharacteristic:('own) bluetoothRemoteGATTCharacteristic_like -> unit Js.Promise.t = "writeValue" [@@bs.send.pipe: ('own) bluetoothRemoteGATTCharacteristic_like] 
 ...
 module TestBindingProxy = struct
    ...
    external getItem : index:int -> testBindingProxy:('own) testBindingProxy_like -> string = "getItem" [@@bs.send.pipe: ('own) testBindingProxy_like] 
    external getNamedItem : item_name:string -> testBindingProxy:('own) testBindingProxy_like -> string = "getNamedItem" [@@bs.send.pipe: ('own) testBindingProxy_like] 
    external removeItem : name:string -> testBindingProxy:('own) testBindingProxy_like -> unit = "removeItem" [@@bs.send.pipe: ('own) testBindingProxy_like] 
    external setItem : index:int -> value:string -> testBindingProxy:('own) testBindingProxy_like -> unit = "setItem" [@@bs.send.pipe: ('own) testBindingProxy_like] 
    external setNamedItem : item_name:string -> value:string -> testBindingProxy:('own) testBindingProxy_like -> unit = "setNamedItem" [@@bs.send.pipe: ('own) testBindingProxy_like] 
    external toString : testBindingProxy:('own) testBindingProxy_like -> string = "toString" [@@bs.send.pipe: ('own) testBindingProxy_like] 
 ...
 module HTMLFormControlsCollection = struct
    ...
    external namedItem : name:string -> hTMLFormControlsCollection:('own) hTMLFormControlsCollection_like -> 'a495 = "namedItem" [@@bs.send.pipe: ('own) hTMLFormControlsCollection_like] 
 ...
 module CustomEvent = struct
    ...
    external initCustomEvent : type_:string -> bubbles:Js.boolean -> cancelable:Js.boolean -> detail:'a497 -> customEvent:('own) customEvent_like -> unit = "initCustomEvent" [@@bs.send.pipe: ('own) customEvent_like] 
 ...
 module ServiceWorker = struct
    ...
    external postMessage : message:'a502 -> serviceWorker:('own) serviceWorker_like -> unit = "postMessage" [@@bs.send.pipe: ('own) serviceWorker_like] 
 ...
 module WebSocket = struct
    ...
    external close : ?code:int Js.undefined -> ?reason:string Js.undefined -> webSocket:('own) webSocket_like -> unit = "close" [@@bs.send.pipe: ('own) webSocket_like] 
    external send : data:'a511 -> webSocket:('own) webSocket_like -> unit = "send" [@@bs.send.pipe: ('own) webSocket_like] 
 ...
 module ExtendableEvent = struct
    ...
    external waitUntil : f:'a512 -> extendableEvent:('own) extendableEvent_like -> unit = "waitUntil" [@@bs.send.pipe: ('own) extendableEvent_like] 
 ...
 module Bluetooth = struct
    ...
    external getAvailability : bluetooth:('own) bluetooth_like -> Js.boolean Js.Promise.t = "getAvailability" [@@bs.send.pipe: ('own) bluetooth_like] 
    external requestDevice : ?options:(_) requestDeviceOptions_like Js.undefined -> bluetooth:('own) bluetooth_like -> bluetoothDevice Js.Promise.t = "requestDevice" [@@bs.send.pipe: ('own) bluetooth_like] 
 ...
 module Worker = struct
    ...
    external postMessage : message:'a519 -> worker:('own) worker_like -> unit = "postMessage" [@@bs.send.pipe: ('own) worker_like] 
    external terminate : worker:('own) worker_like -> unit = "terminate" [@@bs.send.pipe: ('own) worker_like] 
 ...
 module MediaQueryList = struct
    ...
    external addListener : listener:(_) eventListener_like Js.null -> mediaQueryList:('own) mediaQueryList_like -> unit = "addListener" [@@bs.send.pipe: ('own) mediaQueryList_like] 
    external removeListener : listener:(_) eventListener_like Js.null -> mediaQueryList:('own) mediaQueryList_like -> unit = "removeListener" [@@bs.send.pipe: ('own) mediaQueryList_like] 
 ...
 module CSSKeyframesRule = struct
    ...
    external appendRule : rule:string -> cSSKeyframesRule:('own) cSSKeyframesRule_like -> unit = "appendRule" [@@bs.send.pipe: ('own) cSSKeyframesRule_like] 
    external deleteRule : select:string -> cSSKeyframesRule:('own) cSSKeyframesRule_like -> unit = "deleteRule" [@@bs.send.pipe: ('own) cSSKeyframesRule_like] 
    external findRule : select:string -> cSSKeyframesRule:('own) cSSKeyframesRule_like -> cSSKeyframeRule option = "findRule" [@@bs.send.pipe: ('own) cSSKeyframesRule_like] [@@bs.return null_to_opt]
 ...
 module CSSGroupingRule = struct
    ...
    external deleteRule : index:int -> cSSGroupingRule:('own) cSSGroupingRule_like -> unit = "deleteRule" [@@bs.send.pipe: ('own) cSSGroupingRule_like] 
    external insertRule : rule:string -> index:int -> cSSGroupingRule:('own) cSSGroupingRule_like -> int = "insertRule" [@@bs.send.pipe: ('own) cSSGroupingRule_like] 
 ...
 module BluetoothRemoteGATTService = struct
    ...
    external getCharacteristic : characteristic:'a542 -> bluetoothRemoteGATTService:('own) bluetoothRemoteGATTService_like -> bluetoothRemoteGATTCharacteristic Js.Promise.t = "getCharacteristic" [@@bs.send.pipe: ('own) bluetoothRemoteGATTService_like] 
    external getCharacteristics : ?characteristic:'a543 Js.undefined -> bluetoothRemoteGATTService:('own) bluetoothRemoteGATTService_like -> bluetoothRemoteGATTCharacteristic array Js.Promise.t = "getCharacteristics" [@@bs.send.pipe: ('own) bluetoothRemoteGATTService_like] 
    external getIncludedService : service:'a544 -> bluetoothRemoteGATTService:('own) bluetoothRemoteGATTService_like -> bluetoothRemoteGATTService Js.Promise.t = "getIncludedService" [@@bs.send.pipe: ('own) bluetoothRemoteGATTService_like] 
    external getIncludedServices : ?service:'a545 Js.undefined -> bluetoothRemoteGATTService:('own) bluetoothRemoteGATTService_like -> bluetoothRemoteGATTService array Js.Promise.t = "getIncludedServices" [@@bs.send.pipe: ('own) bluetoothRemoteGATTService_like] 
 ...
 module FileReader = struct
    ...
    external abort : fileReader:('own) fileReader_like -> unit = "abort" [@@bs.send.pipe: ('own) fileReader_like] 
    external readAsArrayBuffer : blob:(_) blob_like -> fileReader:('own) fileReader_like -> unit = "readAsArrayBuffer" [@@bs.send.pipe: ('own) fileReader_like] 
    external readAsDataURL : blob:(_) blob_like -> fileReader:('own) fileReader_like -> unit = "readAsDataURL" [@@bs.send.pipe: ('own) fileReader_like] 
    external readAsText : blob:(_) blob_like -> ?label:string Js.undefined -> fileReader:('own) fileReader_like -> unit = "readAsText" [@@bs.send.pipe: ('own) fileReader_like] 
 ...
 module CSSStyleSheet = struct
    ...
    external deleteRule : index:int -> cSSStyleSheet:('own) cSSStyleSheet_like -> unit = "deleteRule" [@@bs.send.pipe: ('own) cSSStyleSheet_like] 
    external insertRule : rule:string -> index:int -> cSSStyleSheet:('own) cSSStyleSheet_like -> int = "insertRule" [@@bs.send.pipe: ('own) cSSStyleSheet_like] 
 ...
 module XMLHttpRequest = struct
    ...
    external abort : xMLHttpRequest:('own) xMLHttpRequest_like -> unit = "abort" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
    external getAllResponseHeaders : xMLHttpRequest:('own) xMLHttpRequest_like -> string = "getAllResponseHeaders" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
    external getResponseHeader : name:string -> xMLHttpRequest:('own) xMLHttpRequest_like -> string option = "getResponseHeader" [@@bs.send.pipe: ('own) xMLHttpRequest_like] [@@bs.return null_to_opt]
    external open_ : method_:string -> url:string -> xMLHttpRequest:('own) xMLHttpRequest_like -> unit = "open" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
    external overrideMimeType : mime:string -> xMLHttpRequest:('own) xMLHttpRequest_like -> unit = "overrideMimeType" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
    external send : ?data:'a578 Js.undefined -> xMLHttpRequest:('own) xMLHttpRequest_like -> unit = "send" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
    external setRequestHeader : name:string -> value:string -> xMLHttpRequest:('own) xMLHttpRequest_like -> unit = "setRequestHeader" [@@bs.send.pipe: ('own) xMLHttpRequest_like] 
 ...
 module BluetoothPermissionResult = struct
    ...
    external devices : bluetoothPermissionResult:('own) bluetoothPermissionResult_like -> bluetoothDevice array = "devices" [@@bs.send.pipe: ('own) bluetoothPermissionResult_like] 
 ...
 module DissimilarOriginWindow = struct
    ...
    external blur : dissimilarOriginWindow:('own) dissimilarOriginWindow_like -> unit = "blur" [@@bs.send.pipe: ('own) dissimilarOriginWindow_like] 
    external close : dissimilarOriginWindow:('own) dissimilarOriginWindow_like -> unit = "close" [@@bs.send.pipe: ('own) dissimilarOriginWindow_like] 
    external focus : dissimilarOriginWindow:('own) dissimilarOriginWindow_like -> unit = "focus" [@@bs.send.pipe: ('own) dissimilarOriginWindow_like] 
    external postMessage : message:'a582 -> targetOrigin:string -> dissimilarOriginWindow:('own) dissimilarOriginWindow_like -> unit = "postMessage" [@@bs.send.pipe: ('own) dissimilarOriginWindow_like] 
 ...
 module KeyboardEvent = struct
    ...
    external getModifierState : keyArg:string -> keyboardEvent:('own) keyboardEvent_like -> bool = "getModifierState" [@@bs.send.pipe: ('own) keyboardEvent_like] 
    external initKeyboardEvent : typeArg:string -> bubblesArg:Js.boolean -> cancelableArg:Js.boolean -> viewArg:(_) window_like Js.null -> keyArg:string -> locationArg:int -> modifiersListArg:string -> repeat:Js.boolean -> locale:string -> keyboardEvent:('own) keyboardEvent_like -> unit = "initKeyboardEvent" [@@bs.send.pipe: ('own) keyboardEvent_like] 
 ...
 module DocumentFragment = struct
    ...
    external getElementById : elementId:string -> documentFragment:('own) documentFragment_like -> element option = "getElementById" [@@bs.send.pipe: ('own) documentFragment_like] [@@bs.return null_to_opt]
    ...
    external querySelector : selectors:string -> documentFragment:('own) documentFragment_like -> element option = "querySelector" [@@bs.send.pipe: ('own) documentFragment_like] [@@bs.return null_to_opt]
    external querySelectorAll : selectors:string -> documentFragment:('own) documentFragment_like -> nodeList = "querySelectorAll" [@@bs.send.pipe: ('own) documentFragment_like] 
 ...
 module DocumentType = struct
    ...
    external remove : documentType:('own) documentType_like -> unit = "remove" [@@bs.send.pipe: ('own) documentType_like] 
 ...
 module Document = struct
    ...
    external none : name:string -> document:('own) document_like -> 'a727 = "" [@@bs.get_index] 
    external adoptNode : node:(_) node_like -> document:('own) document_like -> node = "adoptNode" [@@bs.send.pipe: ('own) document_like] 
    external append : document:('own) document_like -> (('own) document_like, unit, ('a728)) variadic_func = "append" [@@bs.get]
    external captureEvents : document:('own) document_like -> unit = "captureEvents" [@@bs.send.pipe: ('own) document_like] 
    external clear : document:('own) document_like -> unit = "clear" [@@bs.send.pipe: ('own) document_like] 
    external close : document:('own) document_like -> unit = "close" [@@bs.send.pipe: ('own) document_like] 
    external createAttribute : localName:string -> document:('own) document_like -> attr = "createAttribute" [@@bs.send.pipe: ('own) document_like] 
    external createAttributeNS : namespace:string Js.null -> qualifiedName:string -> document:('own) document_like -> attr = "createAttributeNS" [@@bs.send.pipe: ('own) document_like] 
    external createComment : data:string -> document:('own) document_like -> comment = "createComment" [@@bs.send.pipe: ('own) document_like] 
    external createDocumentFragment : document:('own) document_like -> documentFragment = "createDocumentFragment" [@@bs.send.pipe: ('own) document_like] 
    external createElement : localName:string -> ?options:(_) elementCreationOptions_like Js.undefined -> document:('own) document_like -> element = "createElement" [@@bs.send.pipe: ('own) document_like] 
    external createElementNS : namespace:string Js.null -> qualifiedName:string -> ?options:(_) elementCreationOptions_like Js.undefined -> document:('own) document_like -> element = "createElementNS" [@@bs.send.pipe: ('own) document_like] 
    external createEvent : interface_:string -> document:('own) document_like -> event = "createEvent" [@@bs.send.pipe: ('own) document_like] 
    external createNodeIterator : root:(_) node_like -> ?whatToShow:int Js.undefined -> ?filter:(_) nodeFilter_like Js.null Js.undefined -> document:('own) document_like -> nodeIterator = "createNodeIterator" [@@bs.send.pipe: ('own) document_like] 
    external createProcessingInstruction : target:string -> data:string -> document:('own) document_like -> processingInstruction = "createProcessingInstruction" [@@bs.send.pipe: ('own) document_like] 
    external createRange : document:('own) document_like -> range = "createRange" [@@bs.send.pipe: ('own) document_like] 
    external createTextNode : data:string -> document:('own) document_like -> text = "createTextNode" [@@bs.send.pipe: ('own) document_like] 
    external createTouch : view:(_) window_like -> target:(_) eventTarget_like -> identifier:int -> pageX:float -> pageY:float -> screenX:float -> screenY:float -> document:('own) document_like -> touch = "createTouch" [@@bs.send.pipe: ('own) document_like] 
    ...
    external createTreeWalker : root:(_) node_like -> ?whatToShow:int Js.undefined -> ?filter:(_) nodeFilter_like Js.null Js.undefined -> document:('own) document_like -> treeWalker = "createTreeWalker" [@@bs.send.pipe: ('own) document_like] 
    external elementFromPoint : x:float -> y:float -> document:('own) document_like -> element option = "elementFromPoint" [@@bs.send.pipe: ('own) document_like] [@@bs.return null_to_opt]
    external elementsFromPoint : x:float -> y:float -> document:('own) document_like -> element array = "elementsFromPoint" [@@bs.send.pipe: ('own) document_like] 
    external exitFullscreen : document:('own) document_like -> unit Js.Promise.t = "exitFullscreen" [@@bs.send.pipe: ('own) document_like] 
    external getElementById : elementId:string -> document:('own) document_like -> element option = "getElementById" [@@bs.send.pipe: ('own) document_like] [@@bs.return null_to_opt]
    external getElementsByClassName : classNames:string -> document:('own) document_like -> hTMLCollection = "getElementsByClassName" [@@bs.send.pipe: ('own) document_like] 
    external getElementsByName : elementName:string -> document:('own) document_like -> nodeList = "getElementsByName" [@@bs.send.pipe: ('own) document_like] 
    external getElementsByTagName : qualifiedName:string -> document:('own) document_like -> hTMLCollection = "getElementsByTagName" [@@bs.send.pipe: ('own) document_like] 
    external getElementsByTagNameNS : namespace:string Js.null -> qualifiedName:string -> document:('own) document_like -> hTMLCollection = "getElementsByTagNameNS" [@@bs.send.pipe: ('own) document_like] 
    external hasFocus : document:('own) document_like -> bool = "hasFocus" [@@bs.send.pipe: ('own) document_like] 
    external importNode : node:(_) node_like -> ?deep:Js.boolean Js.undefined -> document:('own) document_like -> node = "importNode" [@@bs.send.pipe: ('own) document_like] 
    external open_ : ?type_:string Js.undefined -> ?replace:string Js.undefined -> document:('own) document_like -> document = "open" [@@bs.send.pipe: ('own) document_like] 
    external prepend : document:('own) document_like -> (('own) document_like, unit, ('a729)) variadic_func = "prepend" [@@bs.get]
    external querySelector : selectors:string -> document:('own) document_like -> element option = "querySelector" [@@bs.send.pipe: ('own) document_like] [@@bs.return null_to_opt]
    external querySelectorAll : selectors:string -> document:('own) document_like -> nodeList = "querySelectorAll" [@@bs.send.pipe: ('own) document_like] 
    external releaseEvents : document:('own) document_like -> unit = "releaseEvents" [@@bs.send.pipe: ('own) document_like] 
 ...
 module CharacterData = struct
    ...
    external appendData : data:string -> characterData:('own) characterData_like -> unit = "appendData" [@@bs.send.pipe: ('own) characterData_like] 
    external before : characterData:('own) characterData_like -> (('own) characterData_like, unit, ('a731)) variadic_func = "before" [@@bs.get]
    external deleteData : offset:int -> count:int -> characterData:('own) characterData_like -> unit = "deleteData" [@@bs.send.pipe: ('own) characterData_like] 
    external insertData : offset:int -> data:string -> characterData:('own) characterData_like -> unit = "insertData" [@@bs.send.pipe: ('own) characterData_like] 
    external remove : characterData:('own) characterData_like -> unit = "remove" [@@bs.send.pipe: ('own) characterData_like] 
    external replaceData : offset:int -> count:int -> data:string -> characterData:('own) characterData_like -> unit = "replaceData" [@@bs.send.pipe: ('own) characterData_like] 
    ...
    external substringData : offset:int -> count:int -> characterData:('own) characterData_like -> string = "substringData" [@@bs.send.pipe: ('own) characterData_like] 
 ...
 module Element = struct
    ...
    external closest : selectors:string -> element:('own) element_like -> element option = "closest" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external enterFormalActivationState : element:('own) element_like -> unit = "enterFormalActivationState" [@@bs.send.pipe: ('own) element_like] 
    external exitFormalActivationState : element:('own) element_like -> unit = "exitFormalActivationState" [@@bs.send.pipe: ('own) element_like] 
    external getAttribute : name:string -> element:('own) element_like -> string option = "getAttribute" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external getAttributeNS : namespace:string Js.null -> localName:string -> element:('own) element_like -> string option = "getAttributeNS" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external getAttributeNames : element:('own) element_like -> string array = "getAttributeNames" [@@bs.send.pipe: ('own) element_like] 
    external getAttributeNode : name:string -> element:('own) element_like -> attr option = "getAttributeNode" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external getAttributeNodeNS : namespace:string Js.null -> localName:string -> element:('own) element_like -> attr option = "getAttributeNodeNS" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external getBoundingClientRect : element:('own) element_like -> dOMRect = "getBoundingClientRect" [@@bs.send.pipe: ('own) element_like] 
    external getClientRects : element:('own) element_like -> dOMRect array = "getClientRects" [@@bs.send.pipe: ('own) element_like] 
    external getElementsByClassName : classNames:string -> element:('own) element_like -> hTMLCollection = "getElementsByClassName" [@@bs.send.pipe: ('own) element_like] 
    external getElementsByTagName : localName:string -> element:('own) element_like -> hTMLCollection = "getElementsByTagName" [@@bs.send.pipe: ('own) element_like] 
    external getElementsByTagNameNS : namespace:string Js.null -> localName:string -> element:('own) element_like -> hTMLCollection = "getElementsByTagNameNS" [@@bs.send.pipe: ('own) element_like] 
    external hasAttribute : name:string -> element:('own) element_like -> bool = "hasAttribute" [@@bs.send.pipe: ('own) element_like] 
    external hasAttributeNS : namespace:string Js.null -> localName:string -> element:('own) element_like -> bool = "hasAttributeNS" [@@bs.send.pipe: ('own) element_like] 
    external hasAttributes : element:('own) element_like -> bool = "hasAttributes" [@@bs.send.pipe: ('own) element_like] 
    external insertAdjacentElement : where_:string -> element:(_) element_like -> element:('own) element_like -> element option = "insertAdjacentElement" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external insertAdjacentHTML : position:string -> html:string -> element:('own) element_like -> unit = "insertAdjacentHTML" [@@bs.send.pipe: ('own) element_like] 
    external insertAdjacentText : where_:string -> data:string -> element:('own) element_like -> unit = "insertAdjacentText" [@@bs.send.pipe: ('own) element_like] 
    external matches : selectors:string -> element:('own) element_like -> bool = "matches" [@@bs.send.pipe: ('own) element_like] 
    external prepend : element:('own) element_like -> (('own) element_like, unit, ('a736)) variadic_func = "prepend" [@@bs.get]
    external querySelector : selectors:string -> element:('own) element_like -> element option = "querySelector" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external querySelectorAll : selectors:string -> element:('own) element_like -> nodeList = "querySelectorAll" [@@bs.send.pipe: ('own) element_like] 
    external remove : element:('own) element_like -> unit = "remove" [@@bs.send.pipe: ('own) element_like] 
    external removeAttribute : name:string -> element:('own) element_like -> unit = "removeAttribute" [@@bs.send.pipe: ('own) element_like] 
    external removeAttributeNS : namespace:string Js.null -> localName:string -> element:('own) element_like -> unit = "removeAttributeNS" [@@bs.send.pipe: ('own) element_like] 
    external removeAttributeNode : oldAttr:(_) attr_like -> element:('own) element_like -> attr = "removeAttributeNode" [@@bs.send.pipe: ('own) element_like] 
    external replaceWith : element:('own) element_like -> (('own) element_like, unit, ('a737)) variadic_func = "replaceWith" [@@bs.get]
    external requestFullscreen : element:('own) element_like -> unit Js.Promise.t = "requestFullscreen" [@@bs.send.pipe: ('own) element_like] 
    external scroll : x:float -> y:float -> element:('own) element_like -> unit = "scroll" [@@bs.send.pipe: ('own) element_like] 
    external scrollBy : x:float -> y:float -> element:('own) element_like -> unit = "scrollBy" [@@bs.send.pipe: ('own) element_like] 
    external scrollTo : x:float -> y:float -> element:('own) element_like -> unit = "scrollTo" [@@bs.send.pipe: ('own) element_like] 
    external setAttribute : name:string -> value:string -> element:('own) element_like -> unit = "setAttribute" [@@bs.send.pipe: ('own) element_like] 
    external setAttributeNS : namespace:string Js.null -> name:string -> value:string -> element:('own) element_like -> unit = "setAttributeNS" [@@bs.send.pipe: ('own) element_like] 
    external setAttributeNode : attr:(_) attr_like -> element:('own) element_like -> attr option = "setAttributeNode" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external setAttributeNodeNS : attr:(_) attr_like -> element:('own) element_like -> attr option = "setAttributeNodeNS" [@@bs.send.pipe: ('own) element_like] [@@bs.return null_to_opt]
    external webkitMatchesSelector : selectors:string -> element:('own) element_like -> bool = "webkitMatchesSelector" [@@bs.send.pipe: ('own) element_like] 
 ...
 module Window = struct
    ...
    external alert : message:string -> window:('own) window_like -> unit = "alert" [@@bs.send.pipe: ('own) window_like] 
    external atob : atob:string -> window:('own) window_like -> string = "atob" [@@bs.send.pipe: ('own) window_like] 
    external btoa : btoa:string -> window:('own) window_like -> string = "btoa" [@@bs.send.pipe: ('own) window_like] 
    external cancelAnimationFrame : handle:int -> window:('own) window_like -> unit = "cancelAnimationFrame" [@@bs.send.pipe: ('own) window_like] 
    external captureEvents : window:('own) window_like -> unit = "captureEvents" [@@bs.send.pipe: ('own) window_like] 
    external clearInterval : ?handle:int Js.undefined -> window:('own) window_like -> unit = "clearInterval" [@@bs.send.pipe: ('own) window_like] 
    external clearTimeout : ?handle:int Js.undefined -> window:('own) window_like -> unit = "clearTimeout" [@@bs.send.pipe: ('own) window_like] 
    external close : window:('own) window_like -> unit = "close" [@@bs.send.pipe: ('own) window_like] 
    external debug : arg:string -> window:('own) window_like -> unit = "debug" [@@bs.send.pipe: ('own) window_like] 
    external fetch : input:'a892 -> ?init:(_) requestInit_like Js.undefined -> window:('own) window_like -> response Js.Promise.t = "fetch" [@@bs.send.pipe: ('own) window_like] 
    external gc : window:('own) window_like -> unit = "gc" [@@bs.send.pipe: ('own) window_like] 
    external getComputedStyle : elt:(_) element_like -> ?pseudoElt:string Js.undefined -> window:('own) window_like -> cSSStyleDeclaration = "getComputedStyle" [@@bs.send.pipe: ('own) window_like] 
    external matchMedia : query:string -> window:('own) window_like -> mediaQueryList = "matchMedia" [@@bs.send.pipe: ('own) window_like] 
    external moveBy : x:int -> y:int -> window:('own) window_like -> unit = "moveBy" [@@bs.send.pipe: ('own) window_like] 
    external moveTo : x:int -> y:int -> window:('own) window_like -> unit = "moveTo" [@@bs.send.pipe: ('own) window_like] 
    external openURLInDefaultBrowser : href:string -> window:('own) window_like -> unit = "openURLInDefaultBrowser" [@@bs.send.pipe: ('own) window_like] 
    external postMessage : message:'a893 -> targetOrigin:string -> window:('own) window_like -> unit = "postMessage" [@@bs.send.pipe: ('own) window_like] 
    external releaseEvents : window:('own) window_like -> unit = "releaseEvents" [@@bs.send.pipe: ('own) window_like] 
    external requestAnimationFrame : callback:(float -> unit [@bs]) -> window:('own) window_like -> int = "requestAnimationFrame" [@@bs.send.pipe: ('own) window_like] 
    external resizeBy : x:int -> y:int -> window:('own) window_like -> unit = "resizeBy" [@@bs.send.pipe: ('own) window_like] 
    external resizeTo : x:int -> y:int -> window:('own) window_like -> unit = "resizeTo" [@@bs.send.pipe: ('own) window_like] 
    external scroll : x:float -> y:float -> window:('own) window_like -> unit = "scroll" [@@bs.send.pipe: ('own) window_like] 
    external scrollBy : x:float -> y:float -> window:('own) window_like -> unit = "scrollBy" [@@bs.send.pipe: ('own) window_like] 
    external scrollTo : x:float -> y:float -> window:('own) window_like -> unit = "scrollTo" [@@bs.send.pipe: ('own) window_like] 
    ...
    external trap : window:('own) window_like -> unit = "trap" [@@bs.send.pipe: ('own) window_like] 
    external webdriverCallback : ?result:'a898 Js.undefined -> window:('own) window_like -> unit = "webdriverCallback" [@@bs.send.pipe: ('own) window_like] 
    external webdriverTimeout : window:('own) window_like -> unit = "webdriverTimeout" [@@bs.send.pipe: ('own) window_like] 
 ...
 module WorkerGlobalScope = struct
    ...
    external atob : atob:string -> workerGlobalScope:('own) workerGlobalScope_like -> string = "atob" [@@bs.send.pipe: ('own) workerGlobalScope_like] 
    external btoa : btoa:string -> workerGlobalScope:('own) workerGlobalScope_like -> string = "btoa" [@@bs.send.pipe: ('own) workerGlobalScope_like] 
    external clearInterval : ?handle:int Js.undefined -> workerGlobalScope:('own) workerGlobalScope_like -> unit = "clearInterval" [@@bs.send.pipe: ('own) workerGlobalScope_like] 
    external clearTimeout : ?handle:int Js.undefined -> workerGlobalScope:('own) workerGlobalScope_like -> unit = "clearTimeout" [@@bs.send.pipe: ('own) workerGlobalScope_like] 
    external fetch : input:'a909 -> ?init:(_) requestInit_like Js.undefined -> workerGlobalScope:('own) workerGlobalScope_like -> response Js.Promise.t = "fetch" [@@bs.send.pipe: ('own) workerGlobalScope_like] 
 ...
 module HTMLElement = struct
    ...
    external blur : hTMLElement:('own) hTMLElement_like -> unit = "blur" [@@bs.send.pipe: ('own) hTMLElement_like] 
    external click : hTMLElement:('own) hTMLElement_like -> unit = "click" [@@bs.send.pipe: ('own) hTMLElement_like] 
    external focus : hTMLElement:('own) hTMLElement_like -> unit = "focus" [@@bs.send.pipe: ('own) hTMLElement_like] 
 ...
 module PaintWorkletGlobalScope = struct
    ...
    external registerPaint : name:string -> paintCtor:(unit -> unit [@bs]) -> paintWorkletGlobalScope:('own) paintWorkletGlobalScope_like -> unit = "registerPaint" [@@bs.send.pipe: ('own) paintWorkletGlobalScope_like] 
 ...
 module DedicatedWorkerGlobalScope = struct
    ...
    external close : dedicatedWorkerGlobalScope:('own) dedicatedWorkerGlobalScope_like -> unit = "close" [@@bs.send.pipe: ('own) dedicatedWorkerGlobalScope_like] 
    external postMessage : message:'a1057 -> dedicatedWorkerGlobalScope:('own) dedicatedWorkerGlobalScope_like -> unit = "postMessage" [@@bs.send.pipe: ('own) dedicatedWorkerGlobalScope_like] 
 ...
 module TestWorkletGlobalScope = struct
    ...
    external registerKeyValue : key:string -> value:string -> testWorkletGlobalScope:('own) testWorkletGlobalScope_like -> unit = "registerKeyValue" [@@bs.send.pipe: ('own) testWorkletGlobalScope_like] 
 ...
 module Text = struct
    ...
    external splitText : offset:int -> text:('own) text_like -> text = "splitText" [@@bs.send.pipe: ('own) text_like] 
 ...
 module HTMLIFrameElement = struct
    ...
    external getVisible : hTMLIFrameElement:('own) hTMLIFrameElement_like -> bool = "getVisible" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
    external goBack : hTMLIFrameElement:('own) hTMLIFrameElement_like -> unit = "goBack" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
    external goForward : hTMLIFrameElement:('own) hTMLIFrameElement_like -> unit = "goForward" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
    external reload : ?hardReload:Js.boolean Js.undefined -> hTMLIFrameElement:('own) hTMLIFrameElement_like -> unit = "reload" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
    external setVisible : visible:Js.boolean -> hTMLIFrameElement:('own) hTMLIFrameElement_like -> unit = "setVisible" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
    external stop : hTMLIFrameElement:('own) hTMLIFrameElement_like -> unit = "stop" [@@bs.send.pipe: ('own) hTMLIFrameElement_like] 
 ...
 module HTMLMediaElement = struct
    ...
    external canPlayType : type_:string -> hTMLMediaElement:('own) hTMLMediaElement_like -> string = "canPlayType" [@@bs.send.pipe: ('own) hTMLMediaElement_like] 
    external load : hTMLMediaElement:('own) hTMLMediaElement_like -> unit = "load" [@@bs.send.pipe: ('own) hTMLMediaElement_like] 
    external pause : hTMLMediaElement:('own) hTMLMediaElement_like -> unit = "pause" [@@bs.send.pipe: ('own) hTMLMediaElement_like] 
    external play : hTMLMediaElement:('own) hTMLMediaElement_like -> unit = "play" [@@bs.send.pipe: ('own) hTMLMediaElement_like] 
 ...
 module HTMLTableSectionElement = struct
    ...
    external deleteRow : index:int -> hTMLTableSectionElement:('own) hTMLTableSectionElement_like -> unit = "deleteRow" [@@bs.send.pipe: ('own) hTMLTableSectionElement_like] 
    external insertRow : ?index:int Js.undefined -> hTMLTableSectionElement:('own) hTMLTableSectionElement_like -> hTMLElement = "insertRow" [@@bs.send.pipe: ('own) hTMLTableSectionElement_like] 
 ...
 module HTMLAnchorElement = struct
    ...
    external toString : hTMLAnchorElement:('own) hTMLAnchorElement_like -> string = "toString" [@@bs.send.pipe: ('own) hTMLAnchorElement_like] 
 ...
 module HTMLSelectElement = struct
    ...
    external add : element:'a1086 -> ?before:'a1087 Js.undefined -> hTMLSelectElement:('own) hTMLSelectElement_like -> unit = "add" [@@bs.send.pipe: ('own) hTMLSelectElement_like] 
    external item : index:int -> hTMLSelectElement:('own) hTMLSelectElement_like -> element option = "item" [@@bs.send.pipe: ('own) hTMLSelectElement_like] [@@bs.return null_to_opt]
    external namedItem : name:string -> hTMLSelectElement:('own) hTMLSelectElement_like -> hTMLOptionElement option = "namedItem" [@@bs.send.pipe: ('own) hTMLSelectElement_like] [@@bs.return null_to_opt]
    external remove : index:int -> hTMLSelectElement:('own) hTMLSelectElement_like -> unit = "remove" [@@bs.send.pipe: ('own) hTMLSelectElement_like] 
 ...
 module HTMLTextAreaElement = struct
    ...
    external setSelectionRange : start:int -> end_:int -> ?direction:string Js.undefined -> hTMLTextAreaElement:('own) hTMLTextAreaElement_like -> unit = "setSelectionRange" [@@bs.send.pipe: ('own) hTMLTextAreaElement_like] 
 ...
 module HTMLInputElement = struct
    ...
    external selectFiles : path:string array -> hTMLInputElement:('own) hTMLInputElement_like -> unit = "selectFiles" [@@bs.send.pipe: ('own) hTMLInputElement_like] 
    external setSelectionRange : start:int -> end_:int -> ?direction:string Js.undefined -> hTMLInputElement:('own) hTMLInputElement_like -> unit = "setSelectionRange" [@@bs.send.pipe: ('own) hTMLInputElement_like] 
 ...
 module HTMLFormElement = struct
    ...
    external none : index:int -> hTMLFormElement:('own) hTMLFormElement_like -> element option = "" [@@bs.get_index] [@@bs.return null_to_opt]
    external reset : hTMLFormElement:('own) hTMLFormElement_like -> unit = "reset" [@@bs.send.pipe: ('own) hTMLFormElement_like] 
    external submit : hTMLFormElement:('own) hTMLFormElement_like -> unit = "submit" [@@bs.send.pipe: ('own) hTMLFormElement_like] 
 ...
 module HTMLTableRowElement = struct
    ...
    external deleteCell : index:int -> hTMLTableRowElement:('own) hTMLTableRowElement_like -> unit = "deleteCell" [@@bs.send.pipe: ('own) hTMLTableRowElement_like] 
    external insertCell : ?index:int Js.undefined -> hTMLTableRowElement:('own) hTMLTableRowElement_like -> hTMLElement = "insertCell" [@@bs.send.pipe: ('own) hTMLTableRowElement_like] 
 ...
 module HTMLDialogElement = struct
    ...
    external close : ?returnValue:string Js.undefined -> hTMLDialogElement:('own) hTMLDialogElement_like -> unit = "close" [@@bs.send.pipe: ('own) hTMLDialogElement_like] 
 ...
 module HTMLTableElement = struct
    ...
    external createCaption : hTMLTableElement:('own) hTMLTableElement_like -> hTMLTableCaptionElement = "createCaption" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external createTBody : hTMLTableElement:('own) hTMLTableElement_like -> hTMLTableSectionElement = "createTBody" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external createTFoot : hTMLTableElement:('own) hTMLTableElement_like -> hTMLTableSectionElement = "createTFoot" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external createTHead : hTMLTableElement:('own) hTMLTableElement_like -> hTMLTableSectionElement = "createTHead" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external deleteCaption : hTMLTableElement:('own) hTMLTableElement_like -> unit = "deleteCaption" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external deleteRow : index:int -> hTMLTableElement:('own) hTMLTableElement_like -> unit = "deleteRow" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external deleteTFoot : hTMLTableElement:('own) hTMLTableElement_like -> unit = "deleteTFoot" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external deleteTHead : hTMLTableElement:('own) hTMLTableElement_like -> unit = "deleteTHead" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
    external insertRow : ?index:int Js.undefined -> hTMLTableElement:('own) hTMLTableElement_like -> hTMLTableRowElement = "insertRow" [@@bs.send.pipe: ('own) hTMLTableElement_like] 
